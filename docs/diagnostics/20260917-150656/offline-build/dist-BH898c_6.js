...
var require_ort_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var ort = (() => {
		...
		var Tn = ((e) => typeof __require < "u" ? __require : typeof Proxy < "u" ? new Proxy(e, { get: (t, n) => (typeof __require < "u" ? __require : t)[n] }) : e)(function(e) {
		...
		var it = (e, t) => {
			...
			if (t && typeof t == "object" || typeof t == "function") for (let o of Ju(t)) !ed.call(e, o) && o !== n && Sn(e, o, {
				get: () => t[o],
				enumerable: !(r = Yu(t, o)) || r.enumerable
			});
			return e;
		};
		var mt = (e) => td(Sn({}, "__esModule", { value: !0 }), e);
		var Ct, Qe, Ge, nd, $r, In = k(() => {
			"use strict";
			Ct = /* @__PURE__ */ new Map(), Qe = [], Ge = (e, t, n) => {
				if (t && typeof t.init == "function" && typeof t.createInferenceSessionHandler == "function") {
					let r = Ct.get(e);
					if (r === void 0) Ct.set(e, {
						backend: t,
						priority: n
					});
					else {
					...
					if (n >= 0) {
						let o = Qe.indexOf(e);
						o !== -1 && Qe.splice(o, 1);
						for (let i = 0; i < Qe.length; i++) if (Ct.get(Qe[i]).priority <= n) {
							Qe.splice(i, 0, e);
							return;
						}
						Qe.push(e);
				...
				let t = e.executionProviders || [], n = t.map((u) => typeof u == "string" ? u : u.name), r = n.length === 0 ? Qe : n, o, i = [], s = /* @__PURE__ */ new Set();
				for (let u of r) {
					let d = await nd(u);
		...
		var Tr, pe, Cn = k(() => {
			...
			Object.defineProperty(pe, "logLevel", { enumerable: !0 });
		});
		var te, Ir = k(() => {
			"use strict";
			Cn();
		...
		var An, kr, Pr, zr, Dr, Br, Or = k(() => {
			...
			An = (e, t) => {
				...
				if (n) {
					...
					if (c != null) {
						let p = e.height, f = e.width;
						return c.drawImage(e, 0, 0, f, p), s = c.getImageData(0, 0, f, p).data, a.height = p, a.width = f, An(s, a);
					} else throw new Error("Can not access image data");
				} else {
					if (i) return new Promise((l, c) => {
						...
						m.crossOrigin = "Anonymous", m.src = e, m.onload = () => {
							...
							a.height = p.height, a.width = p.width, l(An(h.data, a));
						};
					});
					throw new Error("Input data provided is not supported - aborted tensor creation");
				}
				if (s !== void 0) return An(s, a);
				throw new Error("Input data provided is not supported - aborted tensor creation");
			}, Pr = (e, t) => {
		...
		var Xe, ft, Mr, Ur, Rr = k(() => {
			...
			Xe = /* @__PURE__ */ new Map([
				...
				if (!Mr) {
					...
					e && (Xe.set("int64", BigInt64Array), ft.set(BigInt64Array, "int64")), t && (Xe.set("uint64", BigUint64Array), ft.set(BigUint64Array, "uint64")), r ? (Xe.set("float16", n), ft.set(n, "float16")) : Xe.set("float16", Uint16Array);
				}
			};
		});
		var Vr, Lr, Nr = k(() => {
		...
		var ht, Wr, be, ye, Re, Ve, kn = k(() => {
			"use strict";
			Cn();
			ht = (e, t) => {
				(typeof pe.trace > "u" ? !pe.wasm.trace : !pe.trace) || console.timeStamp(`${e}::ORT::${t}`);
			}, Wr = (e, t) => {
				...
				(typeof pe.trace > "u" ? !pe.wasm.trace : !pe.trace) || Wr("BEGIN", e);
			}, ye = (e) => {
				(typeof pe.trace > "u" ? !pe.wasm.trace : !pe.trace) || Wr("END", e);
			}, Re = (e) => {
				(typeof pe.trace > "u" ? !pe.wasm.trace : !pe.trace) || console.time(`ORT::${e}`);
			}, Ve = (e) => {
				(typeof pe.trace > "u" ? !pe.wasm.trace : !pe.trace) || console.timeEnd(`ORT::${e}`);
			};
		});
		var Et, Gr = k(() => {
			"use strict";
			...
			Et = class e {
				...
				static async create(t, n, r, o) {
					...
					let [a, u] = await $r(s), d = await a.createInferenceSessionHandler(i, u);
		...
		var Xr, Yr, rd, eo = k(() => {
			...
			He();
			Pt();
			Xr = "ort-wasm-proxy-worker", Yr = globalThis.self?.name === Xr;
			Yr && (self.onmessage = (e) => {
				...
				try {
					switch (t) {
						...
						case "run": {
							...
							Ut(r, o, i, s, new Array(s.length).fill(null), a).then((u) => {
						...
						case "end-profiling": Rt(n), postMessage({ type: t });
					}
				} catch (r) {
					postMessage({
						type: t,
			...
			rd = Yr ? null : (e) => new Worker(e ?? $e, {
				type: "classic",
				name: Xr
			});
		});
		var od, id, $e, Lt, Dn, sd, ad, ro, ud, to, oo, no, io, Pt = k(() => {
			"use strict";
			kt();
			od = typeof location > "u" ? void 0 : location.origin, id = () => {
				...
				try {
					let n = t ?? $e;
					return (n ? new URL(e, n) : new URL(e)).origin === od;
				} catch {
					return !1;
				}
			}, sd = (e, t) => {
			...
			}, ad = (e, t) => `${t ?? "./"}${e}`, ro = async (e) => {
				let n = await (await fetch(e, { credentials: "same-origin" })).blob();
				return URL.createObjectURL(n);
			}, ud = async (e) => (await import(
				/*webpackIgnore:true*/
				/*@vite-ignore*/
				e
)).default, to = (eo(), mt(Jr)).default, oo = async () => {
				if (!$e) throw new Error("Failed to load proxy worker: cannot determine the script source URL.");
				if (Dn($e)) return [void 0, to()];
				let e = await ro($e);
				return [e, to(e)];
			}, no = void 0, io = async (e, t, n, r) => {
				let o = no && !(e || t);
				if (o) if ($e) o = Dn($e) || r && !n;
				else if (r && !n) o = !0;
				else throw new Error("cannot determine the script source URL.");
				if (o) return [void 0, no];
				{
					let i = "ort-wasm-simd-threaded.jsep.mjs", s = e ?? sd(i, t), a = n && s && !Dn(s, t), u = a ? await ro(s) : s ?? ad(i, t);
					return [a ? u : void 0, await ud(u)];
				}
			};
		});
		var Bn, On, Nt, so, dd, ld, cd, zt, ne, He = k(() => {
			"use strict";
			Pt();
			On = !1, Nt = !1, so = !1, dd = () => {
				...
				if (Nt) throw new Error("multiple calls to 'initializeWebAssembly()' detected.");
				if (so) throw new Error("previous call to 'initializeWebAssembly()' failed.");
				Nt = !0;
				...
				let o = e.wasmPaths, i = typeof o == "string" ? o : void 0, s = o?.mjs, a = s?.href ?? s, u = o?.wasm, d = u?.href ?? u, l = e.wasmBinary, [c, p] = await io(a, i, n > 1, !!l || !!d), f = !1, m = [];
				if (t > 0 && m.push(new Promise((h) => {
					...
					p(y).then((g) => {
						Nt = !1, On = !0, Bn = g, h(), c && URL.revokeObjectURL(c);
					}, (g) => {
						Nt = !1, so = !0, b(g);
					});
		...
		var ao, uo = k(() => {
			...
			ao = (e) => {
				...
				try {
					...
					let i = 0;
					return e?.tag !== void 0 && (i = ve(e.tag, r)), n = t._OrtCreateRunOptions(o.logSeverityLevel, o.logVerbosityLevel, !!o.terminate, i), n === 0 && Y("Can't create run options."), e?.extra !== void 0 && yt(e.extra, "", /* @__PURE__ */ new WeakSet(), (s, a) => {
		...
		var pd, md, fd, st, hd, lo, co = k(() => {
			...
			pd = (e) => {
				...
				for (let o of r) {
					...
					switch (i) {
						case "webnn":
							if (i = "WEBNN", st(e, "session.disable_quant_qdq", "1", n), st(e, "session.disable_qdq_constant_folding", "1", n), typeof o != "string") {
								let p = o?.deviceType;
								p && st(e, "deviceType", p, n);
							}
							break;
						case "webgpu":
							if (i = "JS", typeof o != "string") {
								...
								if (c?.preferredLayout) {
									...
									st(e, "preferredLayout", c.preferredLayout, n);
								}
							}
							break;
						case "wasm":
				...
				fd(o);
				try {
					let i = pd(o.graphOptimizationLevel ?? "all"), s = md(o.executionMode ?? "sequential"), a = typeof o.logId == "string" ? ve(o.logId, r) : 0, u = o.logSeverityLevel ?? 2;
					...
					if (n = t._OrtCreateSessionOptions(i, !!o.enableCpuMemArena, !!o.enableMemPattern, s, !!o.enableProfiling, 0, a, u, d, l), n === 0 && Y("Can't create session options."), o.executionProviders && await hd(n, o, r), o.enableGraphCapture !== void 0) {
						if (typeof o.enableGraphCapture != "boolean") throw new Error(`enableGraphCapture must be a boolean value: ${o.enableGraphCapture}`);
						st(n, "enableGraphCapture", o.enableGraphCapture.toString(), r);
					}
					...
					return o.extra !== void 0 && yt(o.extra, "", /* @__PURE__ */ new WeakSet(), (c, p) => {
						st(n, c, p, r);
					}), [n, r];
				} catch (i) {
		...
		var Fe, ke, qe, at, bt, Gt, Ht, Mn, L = k(() => {
			"use strict";
			Fe = (e) => {
				switch (e) {
					case "int8": return 3;
			...
			}, Gt = (e) => e === "float32" || e === "float16" || e === "int32" || e === "int64" || e === "uint32" || e === "uint8" || e === "bool" || e === "uint4" || e === "int4", Ht = (e) => e === "float32" || e === "float16" || e === "int32" || e === "int64" || e === "uint32" || e === "uint64" || e === "int8" || e === "uint8" || e === "bool" || e === "uint4" || e === "int4", Mn = (e) => {
				switch (e) {
					case "none": return 0;
					case "cpu": return 1;
		...
		var gd, yd, po, mo, Ft, bd, Z, Pe = k(() => {
			...
			gd = [
				...
				console.log(`[${gd[e]},${(/* @__PURE__ */ new Date()).toISOString()}]${t}`);
			}, Ft = (e, t) => {
				po = e, mo = t;
			}, bd = (e, t) => {
				let n = bt(e);
				n >= bt(po) && yd(n, typeof t == "function" ? t() : t);
			}, Z = (...e) => {
				mo && bd(...e);
			};
		});
		var Rn, ze, x, Je, qt, fo, ho, H = k(() => {
			"use strict";
			Rn = class {
				...
				static calcShape(t, n, r = !1) {
					...
					if (r) {
						if (o < 2 || i < 2) return;
						let u = Rn.calcMatMulShape([t[o - 2], t[o - 1]], [n[i - 2], n[i - 1]]);
						if (u === void 0) return;
						[a[s - 2], a[s - 1]] = u;
					}
				...
				static computePoolOutputShape(t, n, r, o, i, s, a, u = 0) {
					if (n.length <= 0) throw new Error("input shape must be of size greater than 0");
					let d = [n[0], n[1]];
					return e.computeShapeHelper(t, n, d, r, o, i, s, a, u), d;
				}
				...
				static computeShapeHelper(t, n, r, o, i, s, a, u, d = 0) {
					if (t) for (let l = 0; l < n.length - 2; l++) r.push(1);
					else for (let l = 0; l < n.length - 2; l++) r.push(e.adjustPadAndReturnShape(n[l + 2], o[l], i[l], s[l], a, l, l + n.length - 2, u, d));
				}
				static computeOutputSize(t, n, r, o, i) {
					let s = Math.floor(t / n) + 1;
					return i === 1 && (s = Math.ceil(t / n) + 1, (s - 1) * n >= r + o && (s -= 1)), s;
				}
				static adjustPadAndReturnShape(t, n, r, o, i, s, a, u, d = 0) {
					let l = r * (o - 1) + 1;
					if (u && u !== "NOTSET") switch (u) {
						case "VALID": return i[s] = 0, i[a] = 0, e.computeOutputSize(t - l, n, t, 0, d);
						case "SAME_LOWER":
						case "SAME_UPPER":
							if (r !== 1) throw new Error("Dilation not supported for SAME_UPPER or SAME_LOWER");
							{
								let p = (Math.floor((t + n - 1) / n) - 1) * n + o - t;
								return i[s] = Math.floor(u === "SAME_LOWER" ? (p + 1) / 2 : p / 2), i[a] = p - i[s], e.computeOutputSize(t + i[s] + i[a] - l, n, t, i[s], d);
							}
						default: throw new Error("Unsupported AutoPad type");
					}
					else return e.computeOutputSize(t + i[s] + i[a] - l, n, t, i[s], d);
				}
			}, qt = class {
		...
		var yo, _d, bo, wd, go, $d, _o, jt, Zt, Ln, wo, $o = k(() => {
			"use strict";
			L();
			Pe();
			yo = /* @__PURE__ */ new Map([
				...
				let o = e.byteLength / r, i = new (at(t))(e.buffer, e.byteOffset, o);
				switch (t) {
					case "int64":
					case "uint64": {
				...
				get byteLength() {
					return _o(this.dataType, this.tensorShape);
				}
				destroy() {
				...
				async read(t) {
					if (this.fallbackDataType) {
						let n = await this.mlContext.readTensor(this.mlTensor), r = bo(new Uint8Array(n), this.dataType);
						if (t) {
				...
				async ensureTensor(t, n, r, o) {
					...
					if (!s?.input.dataTypes.includes(n)) {
						if (a = $d.get(n), !a || s?.input.dataTypes.includes(a)) throw new Error(`WebNN backend does not support data type: ${n}`);
					...
					if (this.wrapper) {
						...
						if (o) {
							if (this.wrapper.byteLength !== _o(n, r)) throw new Error("Unable to copy data to tensor with different size.");
				...
				upload(t) {
					let n = t;
					if (this.wrapper) {
						if (this.wrapper.fallbackType) if (this.wrapper.fallbackType === "int32") n = _d(t, this.wrapper.type), this.wrapper.setIsDataConverted(!0);
				...
				async download(t) {
					if (this.activeUpload) {
						let n = this.wrapper?.isDataConverted ? bo(this.activeUpload, this.wrapper?.type) : this.activeUpload;
						if (t) {
				...
				reserveTensorId() {
					let t = go();
					return this.tensorTrackersById.set(t, new Zt(this)), t;
				}
				releaseTensorId(t) {
				...
				registerTensor(t, n, r, o) {
					let i = this.getMLContext(t), s = go(), a = new jt({
						sessionId: t,
						context: i,
						tensor: n,
						dataType: r,
					...
					return this.tensorTrackersById.set(s, new Zt(this, a)), this.externalTensors.add(a), s;
				}
		...
		var Qt, vd, Xt, vo = k(() => {
			...
			Qt = /* @__PURE__ */ new Map([
				...
				async createMLContext(t) {
					...
					let n = this.mlContextCache.findIndex((r) => vd(r.options, t));
				...
				isGraphInputOutputTypeSupported(t, n, r = !0) {
					let o = Qt.get(Fe(n)), i = this.mlOpSupportLimitsBySessionId.get(t);
		...
		var xo, Nn, Wn, xd, Sd, So, Hn, Gn, Io, Co = k(() => {
			"use strict";
			Pe();
			Yt();
			xo = /* @__PURE__ */ new Map([
				...
				[134217728, 6],
				[167772160, 6]
			]), Nn = [], Wn = (e) => Math.ceil(Number(e) / 16) * 16, xd = (e) => {
				for (let t = 0; t < Nn.length; t++) {
					let n = Nn[t];
					if (e <= n) return n;
				}
				return Math.ceil(e / 16) * 16;
			}, Sd = 1, So = () => Sd++, Hn = async (e, t, n, r) => {
				let o = Wn(n), i = e.device.createBuffer({
					size: o,
				...
				constructor(t) {
					...
					for (let [n] of xo) Nn.push(n), this.freeBuffers.set(n, []), this.freeUniformBuffers.set(n, []);
					this.sessionCount = 0;
				}
				upload(t, n) {
					let r = n.buffer, o = n.byteOffset, i = n.byteLength, s = Wn(i), a = this.storageCache.get(t);
					...
					if (s === i && o % 4 === 0) this.backend.device.queue.writeBuffer(a.gpuData.buffer, 0, r, o, i);
					else {
						let u = new Uint8Array(s);
						u.set(n), this.backend.device.queue.writeBuffer(a.gpuData.buffer, 0, u, 0, s);
					}
					Z("verbose", () => `[WebGPU] GpuDataManager.upload(id=${t})`);
				}
				memcpy(t, n) {
					...
					let i = Wn(r.originalSize), s = this.backend.getCommandEncoder();
             ...
             Please use the previous external buffer!`);
				...
				create(t, n = GPUBufferUsage.STORAGE | GPUBufferUsage.COPY_SRC | GPUBufferUsage.COPY_DST) {
					let r = xd(t), o, i = (n & GPUBufferUsage.STORAGE) === GPUBufferUsage.STORAGE, s = (n & GPUBufferUsage.UNIFORM) === GPUBufferUsage.UNIFORM;
					if (i || s) {
				...
				async download(t, n) {
					...
					await Hn(this.backend, r.gpuData.buffer, r.originalSize, n);
				}
		...
		var et, Kn, re, de, P, J, jn, tt, Ie, B, Jt, S, C, Ao, en, qn, Eo, q = k(() => {
			"use strict";
			L();
			H();
			et = 64, Kn = (e, t) => {
				...
				let i = typeof n == "number", s = i ? n : n.length, a = [...new Array(s).keys()], u = s < 2 ? "u32" : s <= 4 ? `vec${s}<u32>` : `array<u32, ${s}>`, d = Kn(t, o), l = typeof d == "string" ? d : d[1], p = {
					indices: u,
					value: l,
					...
					get: !1,
					getByIndices: !1
				}, h = i ? "uniforms." : "", b = `${h}${e}_shape`, y = `${h}${e}_strides`, g = "";
  ...
  fn o2i_${e}(offset: u32) -> ${p.indices} {
    ...
    return indices;
				...
				if (s >= 2) for (let A = s - 1; A >= 0; A--) v.push(`${B(y, A, s)} * (indices[${A}])`);
				let $ = s < 2 ? "" : `
  fn i2o_${e}(indices: ${p.indices}) -> u32 {
    return ${v.join("+")};
					...
					let oe = `${D.name}broadcastedIndicesTo${e}Offset`;
					if (oe in M) return `${oe}(${A})`;
					let he = [];
					for (let ae = s - 1; ae >= 0; ae--) {
						let ge = D.indicesGet("outputIndices", ae + D.rank - s);
						he.push(`${E(y, ae)} * (${ge} % ${E(b, ae)})`);
					}
					return M[oe] = `fn ${oe}(outputIndices: ${D.type.indices}) -> u32 {
             return ${he.length > 0 ? he.join("+") : "0u"};
           }`, `${oe}(${A})`;
				}, W = (A, D) => (() => {
					if (p.storage === p.value) return `${e}[${A}]=${D};`;
					if (p.storage === "vec2<u32>" && p.value === "i32") return `${e}[${A}]=vec2<u32>(u32(${D}), select(0u, 0xFFFFFFFFu, ${D} < 0));`;
					if (p.storage === "vec2<u32>" && p.value === "u32") return `${e}[${A}]=vec2<u32>(u32(${D}), 0u);`;
					if (p.storage === "u32" && p.value === "vec4<bool>") return `${e}[${A}]=dot(vec4<u32>(0x1, 0x100, 0x10000, 0x1000000), vec4<u32>(${D}));`;
  ...
  fn get_${e}ByIndices(indices: ${p.indices}) -> ${l} {
    return ${K(`i2o_${e}(indices)`)};
					...
					let A = a.map((oe) => `d${oe}: u32`).join(", "), D = a.map((oe) => `d${oe}`).join(", ");
					return `
  fn get_${e}(${A}) -> ${l} {
    return get_${e}ByIndices(${I(D)});
					...
					let D = A.map(f).join(",");
					return s === 0 ? K("0u") : s === 1 ? K(D[0]) : (m.get = !0, m.getByIndices = !0, m.indicesToOffset = !0, `get_${e}(${D})`);
				}, N = (A) => s < 2 ? K(A) : (m.getByIndices = !0, m.indicesToOffset = !0, `get_${e}ByIndices(${A})`), j = s < 2 ? "" : `
  ...
  fn set_${e}(${A}, value: ${l}) {
    set_${e}ByIndices(${I(D)}, value);
				...
				return {
					impl: () => {
						let A = [], D = !1;
						return m.offsetToIndices && (A.push(_), D = !0), m.indicesToOffset && (A.push($), D = !0), m.broadcastedIndicesToOffset && (Object.values(M).forEach((oe) => A.push(oe)), D = !0), m.set && (A.push(Q), D = !0), m.setByIndices && (A.push(j), D = !0), m.get && (A.push(R), D = !0), m.getByIndices && (A.push(U), D = !0), !i && D && A.unshift(`const ${b} = ${p.indices}(${n.join(",")});`, `const ${y} = ${p.indices}(${x.computeStrides(n).join(",")});`), A.join(`
`);
					},
					type: p,
					offsetToIndices: w,
					...
					set: (...A) => {
						...
						let D = A[s];
						if (typeof D != "string") throw new Error("value must be string");
						let oe = A.slice(0, s).map(f).join(",");
						return s === 0 ? W("0u", D) : s === 1 ? W(oe[0], D) : (m.set = !0, m.setByIndices = !0, m.indicesToOffset = !0, `set_${e}(${oe}, ${D})`);
					},
					setByOffset: W,
					setByIndices: (A, D) => s < 2 ? W(A, D) : (m.setByIndices = !0, m.indicesToOffset = !0, `set_${e}ByIndices(${A}, ${D});`),
					get: G,
					getByOffset: K,
					getByIndices: N,
					usage: r,
...
`);
		...
		var Td, ko, Id, Cd, Ad, Ed, me, Po, zo, Le = k(() => {
			...
			}, ko = (e, t) => t.length !== 0 ? t : [...new Array(e).keys()].reverse(), Id = (e, t) => x.sortBasedOnPerm(e, ko(e.length, t)), Cd = (e, t, n, r) => {
    ...
    var a: ${n.type.indices};`;
				...
				let n = e.dataType, r = e.dims.length, o = ko(r, t), i = Id(e.dims, o), s = e.dims, a = i, u = r < 2 || Ed(o, e.dims), d;
				if (u) return d = (h) => {
  ...
  ${h.mainStart()}
    ...
    output[global_idx] = input[global_idx];
				...
				let { newShape: l, newPerm: c } = Ad(e.dims, o), p = x.areEqual(c, [
					2,
					3,
					1
				]), f = x.areEqual(c, [
  ...
  var<workgroup> tile : array<array<${g.type.value}, 17>, ${h}>;
  ${b.mainStart([
							h,
							h,
							1
  ...
  ${h.mainStart()}
    ...
    ${y.setByOffset("global_idx", b.getByIndices("aIndices"))}
				...
				Td(e.inputs, t.perm), e.compute(me(e.inputs[0], t.perm));
			}, zo = (e) => V({ perm: e.perm });
		});
        ...
        fn DIV_CEIL(a : u32, b : u32) -> u32 {
         ...
         if (local_idx == 0u) {
          ${c.setByOffset("outputIndex", `${r === "mean" ? `${c.type.storage}(bestValue / f32(uniforms.reduceSize))` : `${c.type.storage}(${Dd[r]})`}`)};
				...
				let o = e.inputs.length === 1 ? n : Zn(e.inputs, n), i = o.axes;
				i.length === 0 && !o.noopWithEmptyAxes && (i = e.inputs[0].dims.map((f, m) => m));
				let s = x.normalizeAxes(i, e.inputs[0].dims.length), a = s, u = e.inputs[0], d = Rd(a, e.inputs[0].dims.length);
				d.length > 0 && (u = e.compute(me(e.inputs[0], d), {
					inputs: [0],
					outputs: [-1]
				})[0], a = Bd(a.length, u.dims.length));
				let [l, c] = Od(u.dims, a), p = l;
				o.keepDims && (p = Md(l, s)), e.compute(Vd(t, o.cacheKey, [u], r, e.inputs[0].dataType, p, c), { inputs: [u] });
			}, Do = (e, t) => {
				De(e, "ReduceMeanShared", t, "mean");
			}, Bo = (e, t) => {
				De(e, "ReduceL1Shared", t, "l1");
			}, Oo = (e, t) => {
				De(e, "ReduceL2Shared", t, "l2");
			}, Mo = (e, t) => {
				De(e, "ReduceLogSumExpShared", t, "logSumExp");
			}, Uo = (e, t) => {
				De(e, "ReduceMaxShared", t, "max");
			}, Ro = (e, t) => {
				De(e, "ReduceMinShared", t, "min");
			}, Vo = (e, t) => {
				De(e, "ReduceProdShared", t, "prod");
			}, Lo = (e, t) => {
				De(e, "ReduceSumShared", t, "sum");
			}, No = (e, t) => {
				De(e, "ReduceSumSquareShared", t, "sumSquare");
			}, Wo = (e, t) => {
				De(e, "ReduceLogSumShared", t, "logSum");
			};
		});
...
`)}
				...
				let n = [];
				return e[1].dims[0] > 0 && e[1].getBigInt64Array().forEach((r) => n.push(Number(r))), V({
					axes: n,
					keepDims: t.keepDims,
					noopWithEmptyAxes: t.noopWithEmptyAxes
				});
			}, Oe = (e, t, n, r) => {
				let o = e.inputs, i = o.length === 1 ? n : Zn(o, n);
				e.compute(nn(t, {
					hint: i.cacheKey,
					inputDependencies: ["rank"]
				}, [o[0]], i.noopWithEmptyAxes && i.axes.length === 0 ? Ld : r, i.axes, o[0].dataType, i.keepDims, i.noopWithEmptyAxes), { inputs: [0] });
			}, Nd = (e, t) => {
				Be(e.inputs), Oe(e, "ReduceLogSum", t, (r, o) => [
				...
				Be(e.inputs), Oe(e, "ReduceL1", t, (r, o) => [
					`var value = ${o.type.storage}(0);`,
					"",
				...
				Be(e.inputs), Oe(e, "ReduceL2", t, (r, o) => [
				...
				Be(e.inputs), Oe(e, "ReduceLogSumExp", t, (r, o) => [
					`var value = ${o.type.storage}(0);`,
					"",
...
`)}`,
				...
				Be(e.inputs), Oe(e, "ReduceMean", t, (r, o, i) => {
					let s = 1;
...
`)}`,
				...
				Be(e.inputs), Oe(e, "ReduceProd", t, (r, o) => [
				...
				Be(e.inputs), Oe(e, "ReduceSum", t, (r, o) => [
					`var value = ${o.type.storage}(0);`,
					"",
					`value += ${r.getByIndices("input_indices")};`,
					""
				...
				Be(e.inputs), Oe(e, "ReduceSumSquare", t, (r, o) => [
					`var t = ${o.type.value}(0); var value = ${o.type.value}(0);`,
					"",
					`t = ${r.getByIndices("input_indices")}; value += t * t;`,
					""
				...
				Me(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? qd(e, t) : Do(e, t);
			}, Fo = (e, t) => {
				Me(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Wd(e, t) : Bo(e, t);
			}, qo = (e, t) => {
				Me(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Gd(e, t) : Oo(e, t);
			}, Ko = (e, t) => {
				Me(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Hd(e, t) : Mo(e, t);
			}, jo = (e, t) => {
				Me(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Fd(e, t) : Uo(e, t);
			}, Zo = (e, t) => {
				Me(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Kd(e, t) : Ro(e, t);
			}, Qo = (e, t) => {
				Me(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? jd(e, t) : Vo(e, t);
			}, Xo = (e, t) => {
				Me(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Zd(e, t) : Lo(e, t);
			}, Yo = (e, t) => {
				Me(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Qd(e, t) : No(e, t);
			}, Jo = (e, t) => {
				Me(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Nd(e, t) : Wo(e, t);
			};
		});
...
var best_index : i32 = 0;`,
    ...
    `, Yd = (e, t, n, r, o, i, s, a) => {
				...
				], f = re(e.dataType, u), m = de(1, u), h = ["type"];
        ...
        for (var total_seq_id: u32 = seq_causal_length; total_seq_id + local_offset < uniforms.total_sequence_length; total_seq_id++) {
          x[offset + total_seq_id] = ${g.type.value}(${$}(0));
				...
				let d = s + i.kvSequenceLength, l = [
					...
					d,
					i.headSize
				] : void 0, m = i.nReps ? i.nReps : 1, h = i.scale === 0 ? 1 / Math.sqrt(i.headSize) : i.scale, b = J(i.headSize), y = i.headSize / b, g = 12, _ = {
					x: Math.ceil(d / g),
				...
				let I = (E) => {
					let z = S("q", t.dataType, t.dims, b), O = [z, S("key", n.dataType, n.dims, b)];
					if (v) {
						let j = S("past_key", r.dataType, r.dims, b);
						O.push(j);
					}
					...
					c && R.push(C("present_key", t.dataType, f, b));
					let G = de(1, b);
					return `
  const TILE_SIZE = ${g}u;

  var<workgroup> tileQ: array<${z.type.storage}, 144>;
  var<workgroup> tileK: array<${z.type.storage}, 144>;
  ${E.registerUniforms([
						{
							name: "M",
							type: "u32"
    ...
    if (global_id.y < uniforms.M && global_id.x < total_sequence_length) {
      ...
      var sum: f32 = ${(() => {
						switch (b) {
							...
							default: throw new Error(`Unsupported components: ${b}`);
						}
					})()};
        output[outputIdx] = ${U.type.value} (sum * uniforms.alpha) + ${o ? "attention_bias[outputIdx]" : "0.0"};
				...
				], g = c && r && x.size(r.dims) > 0, _ = ["type", "type"];
  ...
  ${$.mainStart([
   ...
   if (m < uniforms.M && n < uniforms.N) {
     ...
     output[outputIdx] = value;
			...
			}, ut = (e, t, n, r, o, i, s, a, u, d, l = void 0, c = void 0) => {
				let p = Math.min(e.outputCount, 1 + (s ? 1 : 0) + (a ? 1 : 0)), f = p > 1 ? s : void 0, m = p > 1 ? a : void 0, h = p > 1 ? d.pastSequenceLength : 0, b = h + d.kvSequenceLength, y = u && x.size(u.dims) > 0 ? u : void 0, g = [t, n];
				f && x.size(f.dims) > 0 && g.push(f), y && g.push(y), l && g.push(l), c && g.push(c);
				let _ = e.compute(Jd(p, t, n, f, y, d, h, l, c), {
					inputs: g,
					outputs: p > 1 ? [-1, 1] : [-1]
				})[0];
				e.compute(Yd(_, d.batchSize, d.numHeads, h, d.sequenceLength, b, l, c), {
					inputs: l && c ? [
						_,
						l,
						c
				...
				let w = [_, r];
				m && x.size(m.dims) > 0 && w.push(m), l && w.push(l), c && w.push(c), e.compute(el(p, _, r, m, d, h, l, c), {
					inputs: w,
					outputs: p > 1 ? [0, 2] : [0]
				});
			}, tl = (e, t) => {
				let n = [
					...
					let p = C("output_q", u[0].dataType, n), f = C("output_k", u[0].dataType, n), m = C("output_v", u[0].dataType, n), h = S("input", u[0].dataType, u[0].dims), b = S("weight", u[1].dataType, u[1].dims), y = S("bias", u[2].dataType, u[2].dims), g = h.type.storage;
					return `
  const TILE_SIZE = ${s}u;
  var<workgroup> tileInput: array<${g}, 144>;
  var<workgroup> tileWeightQ: array<${g}, 144>;
  var<workgroup> tileWeightK: array<${g}, 144>;
  var<workgroup> tileWeightV: array<${g}, 144>;
  ${c.registerUniforms([
						{
							name: "M",
							type: "u32"
  ...
  ${c.mainStart([
    ...
    if (m < uniforms.M && n < uniforms.N) {
      ...
      output_v[outputIdx] = valueV;
				...
				let n = Xd(e.inputs, t), [r, o, i] = tl(e, n);
				return ut(e, r, o, i, e.inputs[4], void 0, void 0, void 0, e.inputs[5], n);
			};
		});
  ...
  ${_.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
    ...
    ${b.setByOffset("global_idx", "value")}
				...
				let { inputs: n, outputCount: r } = e, o = ol({
					...t,
					outputCount: r
				});
				if (te.webgpu.validateInputContent && nl(n, o), t.trainingMode) throw new Error("BatchNormalization trainingMode is not supported yet.");
				e.compute(rl(n, o));
			};
		});
		var il, sl, ai, ui = k(() => {
  ...
  ${l.mainStart()}
    ...
    ${u.setByOffset("global_idx", "value")}
				...
				il(e.inputs), e.compute(sl(e.inputs));
			};
		});
  ...
  ${e.mainStart()}
    ...
    ${l.setByOffset("global_idx", u)}
				...
				return s && u.push(...s), {
					...
					getShaderSource: (d) => al(d, x.size(e.dims), e.dataType, i, n, r, a),
					getRunData: (d) => ({
						outputs: [{
							dims: e.dims,
							dataType: i
				...
				let n = t || ul(e.inputs), r = de(e.inputs[0].dataType);
...
fn erf_vf32(v: vec4<${e}>) -> vec4<${e}> {
  ...
  return sign(v) * (1.0 - ((((r5 * x + r4) * x + r3) * x + r2) * x + r1) * x * exp(-absv * absv));
				...
				let t = de(e.inputs[0].dataType);
				e.compute(ee(e.inputs[0], "Erf", (n) => `erf_vf32(${n})`, on(t)));
			}, Si = (e) => {
				...
				let t = de(e.inputs[0].dataType);
				e.compute(ee(e.inputs[0], "Gelu", (n) => `0.5 * ${n} * (1.0 + erf_vf32(${n} * 0.7071067811865475))`, on(t)));
			}, Ci = (e, t) => {
				let n = de(e.inputs[0].dataType);
				...
				let t = de(e.inputs[0].dataType);
				e.compute(ee(e.inputs[0], "HardSwish", (n) => `${n} * max(vec4<${t}>(0.0), min(vec4<${t}>(1.0), vec4<${t}>(${t}(1.0 / 6.0)) * ${n} + vec4<${t}>(0.5)))`));
			}, Mi = (e) => {
			...
			}, Li = (e) => `sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`, Ni = (e) => {
				e.compute(ee(e.inputs[0], "Tanh", Li));
			}, Yn = (e = "f32") => `
...
`, Jn = (e) => `(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`, Wi = (e) => {
				let t = de(e.inputs[0].dataType);
				e.compute(ee(e.inputs[0], "FastGelu", Jn, Yn(t), void 0, e.inputs[0].dataType));
			}, Gi = (e, t) => {
				let n = de(e.inputs[0].dataType);
...
`, ll = (e) => `quick_gelu_impl(${e})`, Fi = (e, t) => {
				let n = de(e.inputs[0].dataType);
				e.compute(ee(e.inputs[0], "QuickGelu", ll, dl(n, t.alpha), t.cacheKey, e.inputs[0].dataType));
			};
		});
		var cl, pl, Ki, ji = k(() => {
			"use strict";
  ...
  ${u.mainStart()}
    ...
    ${o.setByOffset("global_idx", "valueLeft * geluRight")}
				...
				cl(e.inputs), e.compute(pl(e.inputs));
			};
		});
        ...
        ${y}
				...
				return m.push(p), {
					...
					getShaderSource: (h) => ml(h, a, u, l, p, d, f, o, n.dataType, r.dataType, s, i),
					getRunData: () => ({
						outputs: [{
							dims: l,
							dataType: s
				...
				e.compute(fl(t, o ?? "", e.inputs[0], e.inputs[1], n, r, i));
			}, Zi = (e) => {
				Ue(e, "Add", (t, n) => `${t}+${n}`);
			}, Qi = (e) => {
				Ue(e, "Div", (t, n) => `${t}/${n}`);
...
`);
  ...
  ${h.mainStart()}
    ...
    ${bl(s, c)}
				...
				e.compute(_l(s, o, i, n[0].dataType), { inputs: s });
			}, as = (e) => V({ axis: e.axis });
		});
        ...
        `;
				...
				if (t === "HardSigmoid") {
					...
					let [n, r] = e?.activation_params || [fo, ho];
					return {
						activation: t,
						clipMax: r,
						clipMin: n
...
`;
				...
				let s = e[0].dims, a = e[1].dims, u = s[s.length - 2], d = a[a.length - 1], l = s[s.length - 1], c = J(d), p = J(l), f = J(u), m = x.size(n) / c / f, h = e.length > 2, b = r ? r.slice(0, -2) : n.slice(0, -2), g = [
					x.size(b),
					u,
					d
				], _ = [
				...
				Ae(t, _), _.push(...P(b, s, a)), h && _.push(...P(e[2].dims)), _.push(...P(g));
				let w = (v) => {
					let $ = en("batch_dims", e[0].dataType, b.length), T = S("a", e[0].dataType, s.length, p), I = S("b", e[1].dataType, a.length, c), E = C("output", e[0].dataType, g.length, c), z = re(E.type.tensor), M = Ce(t, E.type.value, z), O = [T, I], W = "";
					if (h) {
						let R = o ? c : 1;
...
`;
    ...
    `;
				...
				let s = e[0].dims, a = e[1].dims, u = s.slice(0, -2), d = a.slice(0, -2), l = r ? r.slice(0, -2) : n.slice(0, -2), c = x.size(l), p = s[s.length - 2], f = s[s.length - 1], m = a[a.length - 1], h = f % 4 === 0 && m % 4 === 0, b = p <= 8 ? [
					4,
					1,
					1
				] : [
				...
				let O = (W) => {
					let K = l.length, U = en("batchDims", e[0].dataType, K, 1), R = re(e[0].dataType), G = S("a", e[0].dataType, v, _), N = S("b", e[1].dataType, T, _), j = C("result", e[0].dataType, I.length, _), Q = [G, N];
					if (M) {
						let D = o ? _ : 1;
						Q.push(S("bias", e[2].dataType, e[2].dims.length, D));
					}
					let X = [
						{
							name: "dim_a_outer",
					...
					Ee(t, X);
					let Te = re(j.type.tensor), se = Ce(t, j.type.value, Te), A = xl(_, M, se, [
						U,
						G,
						N,
						j
  ...
  ${h ? er(b, y, R, U) : tr(b, y, R, U)}
		...
		var Sl, ms, fs = k(() => {
			...
			cs();
			cn();
			Sl = (e, t, n, r, o = !1, i, s = 4, a = 4, u = 4, d = "f32") => {
				let l = (z) => {
					switch (z) {
    ...
    return ${ce(a, d)}(0.0);`, v = ce(u, d), $ = e ? ce(s, d) : ce(a, d), T = e ? ce(a, d) : ce(s, d), I = Ce(i, v, d);
				return `
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${v}) {
      ...
      setOutputAtCoords(coords[0], coords[1], coords[2], coords[3], value);
				...
				let d = t.format === "NHWC", l = d ? e[0].dims[3] : e[0].dims[1], c = n[0], p = d ? n[2] : n[3], f = d ? n[1] : n[2], m = d ? n[3] : n[1], h = d && (l % 4 === 0 || l % 3 === 0) && m % 4 === 0, b = d ? m : p * f, y = d ? p * f : m, g = [
					8,
					8,
					1
				], _ = r <= 8 ? [
				...
				let v = h ? d && l % 4 !== 0 ? 3 : 4 : 1, $ = g[1] * _[1], T = g[0] * _[0], I = Math.max(g[0] * v, g[1]), E = r % $ === 0, z = o % T === 0, M = i % I === 0, O = h ? [
					v,
					4,
					4
				] : [
				...
				let U = (R) => {
					...
					Ee(t, G);
					let N = h ? 4 : 1, j = re(e[0].dataType), Q = `
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${h ? `vec4<${j}>` : j}) {
      ...
      }`, se = [S("x", e[0].dataType, e[0].dims.length, v === 3 ? 1 : v), S("w", e[1].dataType, e[1].dims.length, N)], A = C("result", e[0].dataType, n.length, N);
					if (s) {
						let D = S("bias", e[2].dataType, e[2].dims.length, N);
						se.push(D), Q += `
		...
		var Tl, hs, pn, Il, gs, Cl, ys, bs, _s = k(() => {
			...
			Tl = (e) => {
				...
				return t;
			}, hs = (e) => typeof e == "number" ? [
				e,
				e,
				e
			] : e, pn = (e, t) => t <= 1 ? e : e + (e - 1) * (t - 1), Il = (e, t, n, r = 1) => {
				let o = pn(t, r);
				...
				if (e === "VALID" && (e = 0), typeof e == "number") {
					...
					let m = (c - 1) * o + a - t, h = (p - 1) * i + u - n, b = (f - 1) * s + d - r, y = Math.floor(m / 2), g = m - y, _ = Math.floor(h / 2), w = h - _, v = Math.floor(b / 2);
					l = {
						top: _,
						bottom: w,
						left: v,
			...
			}, ys = (e, t, n, r, o, i = !1, s = "channelsLast") => {
				let a, u, d, l, c;
				if (s === "channelsLast") [a, u, d, l, c] = e;
				else if (s === "channelsFirst") [a, c, u, d, l] = e;
				else throw new Error(`Unknown dataFormat ${s}`);
				let [p, , f, m, h] = t, [b, y, g] = hs(n), [_, w, v] = hs(r), $ = pn(f, _), T = pn(m, w), I = pn(h, v), { padInfo: E, outDepth: z, outHeight: M, outWidth: O } = Cl(o, u, d, l, b, y, g, $, T, I), W = i ? p * c : p, K = [
					0,
					0,
					0,
					0,
				...
				let d = [
					...
					Math.ceil(Tl(l.x.map((g) => n[g])) / d[0]),
					1,
					1
				];
		...
		var ws, $s, vs = k(() => {
			...
			ws = (e, t, n, r) => {
				...
				let h = (b) => {
					let y = C("output", e[0].dataType, n.length, c), g = re(y.type.tensor), _ = Ce(t, y.type.value, g), w = S("x", e[0].dataType, s.length), v = S("w", e[1].dataType, a.length, c), $ = [w, v];
  ...
  ${b.mainStart()}
    ...
    ${y.setByOffset("global_idx", "value")}
				...
				let p = (s - 1) * t.strides[1] + d[1], f = (m) => {
					let h = C("output", e[0].dataType, l.length, i), b = re(h.type.tensor), y = Ce(t, h.type.value, b), g = S("x", e[0].dataType, u.length, i), _ = S("w", e[1].dataType, d.length, i), w = [g, _];
  ...
  ${m.mainStart()}
    ...
    for (var i = 0u; i < ${s}u; i++) {
      ...
      ${h.set("batch", "row", "col + i", "output_channel", "value")};
		...
		var Al, nr, El, rr, or, xs, kl, Pl, ir, Ss = k(() => {
			"use strict";
			H();
			fs();
			_s();
			...
			Al = (e, t, n, r, o, i) => {
				...
				let r = e.pads.slice();
				Je.adjustPadsBasedOnAutoPad(t[0].dims, e.strides, e.dilations, n, r, e.format === "NHWC", e.autoPad);
				...
				let o = n.format === "NHWC", i = Al(t[0].dims, t[1].dims, n.dilations, n.pads, n.strides, o);
				if (n.group !== 1) {
					let $ = [t[0]];
					if (o) {
						let I = e.kernelCustomData.wT ?? e.compute(me(t[1], nr), {
							inputs: [1],
							outputs: [n.wIsConst ? -2 : -1]
						})[0];
						n.wIsConst && !e.kernelCustomData.wT && (e.kernelCustomData.wT = I), $.push(I);
					} else $.push(t[1]);
					t.length === 3 && $.push(t[2]), !e.adapterInfo.isArchitecture("ampere") && o && t[1].dims[0] === n.group && t[1].dims[1] === 1 && n.dilations[0] === 1 && n.dilations[1] === 1 ? e.compute($s($, n, i, r), { inputs: $ }) : e.compute(ws($, n, i, r), { inputs: $ });
					return;
				}
				...
				if (h || l === 1 && c === 1 && n.dilations[0] === 1 && n.dilations[1] === 1 && n.strides[0] === 1 && n.strides[1] === 1 && n.pads[0] === 0 && n.pads[1] === 0) {
					let $ = i[0], T, I, E, z = [];
					if (o) {
						let W = e.kernelCustomData.wT ?? e.compute(me(t[1], nr), {
							inputs: [1],
							outputs: [n.wIsConst ? -2 : -1]
						})[0];
					...
					M < 8 && O < 8 ? e.compute(dn(z, n, i, E, o, r), { inputs: z }) : e.compute(vt(z, n, i, E, o, r), { inputs: z });
					return;
				}
				let b = !0, y = e.kernelCustomData.wT ?? e.compute(me(t[1], nr), {
					inputs: [1],
					outputs: [n.wIsConst ? -2 : -1]
				})[0];
				...
				e.compute(ms(g, n, i, _, w, v, s, b, r), { inputs: g });
			}, kl = (e, t) => {
				...
				let o = [
					...
					0,
					t.pads[1]
				], i = [1].concat(t.strides), s = [1].concat(t.dilations), a = [1].concat(t.kernelShape), u = rr({
					...t,
					pads: o,
					strides: i,
					dilations: s,
				...
				let r = n.format === "NHWC" ? "channelsLast" : "channelsFirst", o = rr(n, t), i = n.autoPad === "NOTSET" ? n.pads : n.autoPad, s = ys(t[0].dims, t[1].dims, n.strides, n.dilations, i, !1, r);
				e.compute(bs(t, o, s.outShape, [
					s.filterDepth,
					s.filterHeight,
					s.filterWidth
				], [
				...
				if (El(e.inputs, t), e.inputs[0].dims.length === 3) kl(e, t);
				else if (e.inputs[0].dims.length === 5) Pl(e, e.inputs, t);
				else {
					let n = rr(t, e.inputs);
					xs(e, e.inputs, n);
				}
		...
		var Ts, Is = k(() => {
			...
			q();
			Ts = (e, t, n) => {
				let r = e.length > 2, o = t.outputShape, i = t.format === "NHWC", s = t.group, a = e[1].dims, u = a[2] / s, d = a[3], l = i ? J(u) : 1, c = i && d === 1 && u >= 4, p = c ? Math.floor(u / 4) * 4 : Math.floor(u / l) * l, f = u - p, m = i ? J(d) : 1, h = i ? d === 1 ? l : m : 1, b = x.size(o) / m, y = [
					Math.ceil(b / 64),
					1,
					1
				];
				Z("verbose", () => `[conv2d_backprop_webgpu] dispatch = ${y}`);
				let g = ["rank", "rank"], _ = [t.strides[0], t.strides[1]], w = [t.kernelShape[i ? 1 : 2], t.kernelShape[i ? 2 : 3]], v = [t.dilations[0], t.dilations[1]], $ = [w[0] + (t.dilations[0] <= 1 ? 0 : (t.kernelShape[i ? 1 : 2] - 1) * (t.dilations[0] - 1)), w[1] + (t.dilations[1] <= 1 ? 0 : (t.kernelShape[i ? 2 : 3] - 1) * (t.dilations[1] - 1))], T = [$[0] - 1 - Math.floor((t.pads[0] + t.pads[2]) / 2), $[1] - 1 - Math.floor((t.pads[1] + t.pads[3]) / 2)], I = [
					{
						type: 12,
						data: b
					},
				...
				let E = (z) => {
					...
					], O = re(e[0].dataType), W = i ? 1 : 2, K = i ? 2 : 3, U = i ? 3 : 1, R = S("W", e[1].dataType, e[1].dims.length, h), G = S("Dy", e[0].dataType, e[0].dims.length, l), N = [G, R];
					r && N.push(S("bias", e[2].dataType, [o[U]].length, m));
    ...
    ${Te}}`;
		...
		var zl, Dl, Bl, Cs, As, Ol, Es, Ml, ks, Ps = k(() => {
			"use strict";
			Is();
			Ke();
			Le();
			zl = (e, t, n, r, o, i) => (e - 1) * t + n + (r - 1) * o + 1 - i, Dl = (e, t, n, r, o) => {
				let i = Math.floor(e / 2);
				t === "SAME_UPPER" ? (n[r] = i, n[o] = e - i) : t === "SAME_LOWER" && (n[r] = e - i, n[o] = i);
			}, Bl = (e, t, n, r, o, i, s, a, u, d) => {
				...
				for (let m = 0, h = e.length - l - (a ? 1 : 0); m < l; ++m, ++h) {
					let b = e[h], y = c ? b * s[m] : d[m], g = zl(b, s[m], i[m], t[h], n[m], y);
					Dl(g, r, i, m, m + l), c && d.push(s[m] * (b - 1) + u[m] + (t[h] - 1) * n[m] + 1 - i[m] - i[m + l]);
				}
				...
				Bl(a, n, u, e.autoPad, e.group, o, d, r, s, i);
				...
				let i = [t[0], o];
				t.length === 3 && i.push(t[2]), e.compute(Ts(i, n, r), { inputs: i });
			}, Ml = (e, t) => {
				let n = t.format === "NHWC", r = [e.inputs[0].reshape(n ? [
					e.inputs[0].dims[0],
					1,
				...
				if (Ol(e.inputs, t), e.inputs[0].dims.length === 3) Ml(e, t);
				else {
					let n = Cs(t, e.inputs);
					Es(e, e.inputs, n);
				}
...
`);
  ...
  ${y.mainStart()}
    ...
    ${h.setByOffset("global_idx", m.getByIndices("aIndices"))}
				...
				return {
					...
					getRunData: (y) => {
						let g = u ? [
							...
							r * d,
							o * d
						], _ = x.size(g), w = c.dims, v = x.sortBasedOnPerm(w, a);
						return {
							outputs: [{
								dims: g,
				...
				Rl(e.inputs), e.compute(Ll(e.inputs[0], t));
			}, Ms = (e) => V({
		...
		var je, mn, sr, Vs, nt, Nl, Wl, Gl, Ls, Ns, Ws, Hl, Fl, Rs, ql, Gs, Hs, Fs = k(() => {
			...
			ue();
			q();
			je = 256, mn = 512, sr = 2 * Math.PI, Vs = (e) => {
				let t = [], n = e;
				for (let r of [
					4,
					2,
					3,
					5
				]) for (; n % r === 0;) t.push(r), n /= r;
				return n === 1 ? t : void 0;
			}, nt = (e) => {
				let t = e.toPrecision(9);
...
`;
				for (let d = 0; d < e; d++) {
					let l = `${r}u + t + ${d * i}u`;
					if (d === 0) u += `    leg[0] = smem[${l}];
`;
					else {
						let c = o * sr * d / (e * t);
						u += `    { let a = ${nt(c)} * angleUnit; leg[${d}] = cmul(smem[${l}], vec2<f32>(cos(a), sin(a))); }
`;
					}
				}
...
`;
					...
					let d = o < 0 ? "vec2<f32>(oddDiff.y, -oddDiff.x)" : "vec2<f32>(-oddDiff.y, oddDiff.x)";
					u += `    let evenSum = leg[0] + leg[2]; let evenDiff = leg[0] - leg[2];
...
`;
					...
					let l = ["leg[0]"];
					for (let c = 1; c < e; c++) {
						let p = o * sr * (c * d) / e, f = nt(Math.cos(p)), m = nt(Math.sin(p));
						l.push(`vec2<f32>(leg[${c}].x*${f} - leg[${c}].y*${m}, leg[${c}].x*${m} + leg[${c}].y*${f})`);
					}
					u += `    ${a(d)} = ${l.join(" + ")};
`;
				}
...
`;
				...
				let r = "", o = 1, i = 0;
				for (let s of e) r += Nl(s, o, t, i, n), o *= s, i = mn - i;
				return {
					code: r,
					resultOffset: i
				};
			}, Gl = (e, t, n, r, o) => {
				let i = e.dims, s = i.length, a = i[s - 1], u = i[t], d = n && r ? (u - 1) * 2 : u;
				o !== void 0 && (d = o);
				let l = n && r ? 1 : 2, c = r && !n ? Math.floor(d / 2) + 1 : d, p = i.slice();
				p[t] = c, p[s - 1] = l;
				let f = 1;
				for (let h = t + 1; h < s - 1; h++) f *= i[h];
				let m = x.size(i) / a / u;
				return {
					dataType: e.dataType,
					outputDims: p,
			...
			], Ws = (e, t, n) => e.registerUniform("batch", "u32").registerUniform("signalLength", "u32").registerUniform("inner", "u32").registerUniform("outputLength", "u32").declareVariables(t, n), Hl = (e) => {
				let { dataType: t, length: n, inputComponents: r, outputComponents: o, inverse: i, onesided: s } = e, a = de(t), u = i ? 1 : -1, d = i ? 1 / n : 1, l = Vs(n), c = (p) => {
					let f = S("x", t, [1]), m = C("y", t, [1]), h = (v) => {
						let $ = `inBase + (${v}) * uniforms.inner * ${r}u`;
						return `vec2<f32>(${`f32(${f.getByOffset($)})`}, ${r === 2 ? `f32(${f.getByOffset(`${$} + 1u`)})` : "0.0"})`;
					}, b;
					if (i && s) {
						let v = Math.floor(n / 2) + 1, $ = n % 2 === 0 ? `select(provided, provided - 1u, provided == ${v}u)` : "provided";
						b = `
    ...
    workgroupBarrier();`;
					let { code: y, resultOffset: g } = Wl(l, n, u), _ = d === 1 ? `smem[${g}u + i]` : `smem[${g}u + i] * ${nt(d)}`, w = o === 2 ? m.setByOffset("off + 1u", `${a}(v.y)`) : "";
					return `
  ${Ws(p, f, m)}
...
${y}    for (var i = local_idx; i < uniforms.outputLength; i += ${je}u) {
      ...
      ${w}
				...
				return {
					...
					getRunData: () => ({
						...
						programUniforms: Ns(e),
						dispatchGroup: { x: e.batch }
					})
				};
			}, Fl = (e) => {
				let { dataType: t, length: n, inputComponents: r, outputComponents: o, inverse: i, onesided: s } = e, a = de(t), u = i ? 1 : -1, d = i ? 1 / n : 1, l = (c) => {
					let p = S("x", t, [1]), f = C("y", t, [1]), m = (_) => {
						let w = `inBase + (${_}) * uniforms.inner * ${r}u`;
						return `vec2<f32>(${`f32(${p.getByOffset(w)})`}, ${r === 2 ? `f32(${p.getByOffset(`${w} + 1u`)})` : "0.0"})`;
					}, h = i && s ? `fn spectrum(inBase: u32, k: u32) -> vec2<f32> {
    ...
    return vec2<f32>(0.0, 0.0);
      ...
      knMod += k;
      if (knMod >= ${n}u) { knMod -= ${n}u; }`, y = o === 2 ? f.setByOffset("off + 1u", `${a}(v.y)`) : "", g = d === 1 ? "acc" : `acc * ${nt(d)}`;
					return `
  ${Ws(c, p, f)}
  fn cmul(a: vec2<f32>, b: vec2<f32>) -> vec2<f32> {
    return vec2<f32>(a.x * b.x - a.y * b.y, a.x * b.y + a.y * b.x);
  ...
  ${c.mainStart(je)}
    ...
    for (var k = local_idx; k < uniforms.outputLength; k += ${je}u) {
      ...
      ${y}
				...
				if (!e || e.dataType === 0) return;
				if (x.size(e.dims) !== 1) throw new Error("DFT optional scalar inputs must have exactly 1 element.");
				if (e.dataType === 6) return e.getInt32Array()[0];
				let t = Number(e.getBigInt64Array()[0]);
				if (!Number.isSafeInteger(t)) throw new Error("DFT optional scalar inputs are out of JavaScript safe integer range.");
				return t;
			}, ql = (e) => {
				if (!e || e.length < 1) throw new Error("DFT requires at least 1 input.");
				let t = e[0].dims;
				if (t.length < 2) throw new Error("DFT input must have at least 2 dimensions.");
				let n = t[t.length - 1];
				if (n !== 1 && n !== 2) throw new Error("DFT input's innermost dimension must be 1 (real) or 2 (complex).");
			}, Gs = (e, t) => {
				ql(e.inputs);
				let n = e.inputs[0], r = n.dims.length, o = t.inverse !== 0, i = t.onesided !== 0, s = Rs(e.inputs[1]);
				if (s !== void 0 && s <= 0) throw new Error("dft_length must be greater than zero.");
				let a = x.normalizeAxis(Rs(e.inputs[2]) ?? t.axis, r);
				if (a === r - 1) throw new Error("DFT axis must refer to a signal dimension, not the innermost (real/imaginary) dimension.");
				if (o && i && n.dims[r - 1] !== 2) throw new Error("Inverse one-sided DFT (IRFFT) requires complex-valued input (innermost dimension 2).");
				let u = Gl(n, a, o, i, s);
				if (u.length <= 0) throw new Error(`Invalid DFT length: ${u.length}`);
				let l = u.length <= mn && Vs(u.length) !== void 0 ? Hl(u) : Fl(u);
				e.compute(l, { inputs: [0] });
			}, Hs = (e) => V({
				axis: e.axis ?? 1,
				inverse: e.inverse ?? 0,
				onesided: e.onesided ?? 0
			});
		});
		var ar, fn, qs, Kl, jl, ur, dr, Ks, Zl, js, Zs, Qs = k(() => {
			...
			ue();
			q();
			ar = "[a-zA-Z]|\\.\\.\\.", fn = "(" + ar + ")+", qs = "^" + fn + "$", Kl = "(" + fn + ",)*" + fn, jl = "^" + Kl + "$", ur = class {
				constructor(t = -1) {
				...
				constructor(t, n) {
					...
					if (!r.match(RegExp(jl))) throw new Error("Invalid LHS term");
					if (r.split(",").forEach((a, u) => {
						let d = t[u].dims.slice();
						if (!a.match(RegExp(qs))) throw new Error("Invalid LHS term");
						let l = this.processTerm(a, !0, d, u);
						this.lhs.push(l);
					}), o === "") o += [...this.symbolToInfo.entries()].filter(([a, u]) => u.count === 1 || a === "...").map(([a]) => a).join("");
					else if (!o.match(RegExp(fn))) throw new Error("Invalid RHS");
					o.match(RegExp(ar, "g"))?.forEach((a) => {
				...
				processTerm(t, n, r, o = -1) {
					...
					if (!t.match(RegExp(qs)) && !n && t !== "") throw new Error("Invalid LHS term");
					let d = t.match(RegExp(ar, "g")), l = new ur(o);
				...
				let i = e.map((l) => l.length).map((l, c) => S(`input${c}`, t, l)), s = x.size(r), a = C("output", t, r.length), u = [...n.symbolToInfo.keys()].filter((l) => !n.rhs.symbolToIndices.has(l)), d = (l) => {
					...
					n.symbolToInfo.forEach((v, $) => {
						...
						}), b.push(`for(var ${$}: u32 = 0; ${$} < uniforms.${Ks($)}; ${$}++) {`), y.push("}");
					});
					let w = _ ? [...c, `let sum = ${i.map((v, $) => v.getByIndices(`input${$}Indices`)).join(" * ")};`] : [
						...c,
						f,
						...b,
						...h,
...
`)};
            ${a.setByOffset("global_idx", "sum")};
				...
				let n = new dr(e.inputs, t.equation), r = n.outputDims, o = e.inputs.map((i, s) => i.dims);
				e.compute(Zl(o, e.inputs[0].dataType, n, r));
			}, Zs = (e) => {
		...
		var Ql, Xs, Xl, Yl, Ys, Js = k(() => {
			...
			Ql = (e) => {
				...
				return r;
			}, Xl = (e, t) => e.length > t.length ? Xs(e, t) : Xs(t, e), Yl = (e) => {
    ...
    ${m}`;
				...
				Ql(e.inputs), e.compute(Yl(e.inputs), { inputs: [0] });
			};
		});
		var Jl, ea, ta = k(() => {
			"use strict";
    ...
    ${s.mainStart(et)}
      ...
      ${d.setByOffset("global_idx", Jn("x_in"))}
				...
				e.inputs.length < 2 || x.size(e.inputs[1].dims) === 0 ? Wi(e) : e.compute(Jl(e.inputs));
			};
		});
      ...
      ${p.mainStart()}
        ...
        ${y}
			...
			}, na = (e) => V({ axis: e.axis }), ra = (e, t) => {
				let n = e.inputs;
				ec(n), e.compute(tc(e.inputs, t));
			};
		});
		var nc, ia, sa, aa = k(() => {
			"use strict";
			...
			nc = (e, t, n, r, o, i, s, a, u) => {
				...
				d.push(...P(t.dims, l));
				let c = (p) => {
					let h = [S("indices_data", t.dataType, t.dims.length), C("input_slice_offsets_data", 12, 1, 1)], b = [
						{
							name: "output_size",
							type: "u32"
						},
  ...
  ${p.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
				...
				let m = nc(e, n[1], p, t.batchDims, r, a, c, l, s), h = t.batchDims + s;
				if (h > r.length) throw new Error("last dimension of indices must not be larger than rank of input tensor");
				let b = i.slice(0, -1).concat(r.slice(h)), y = x.size(b), g = [
					{
						type: 12,
						data: y
					},
		...
		var rc, oc, ua, da, la = k(() => {
			...
			rc = (e, t) => {
				...
				let u = x.size(a), d = e[2].dataType, c = e[0].dataType === 22, p = [
					...
					let h = S("data", e[0].dataType, e[0].dims.length), b = S("inputIndices", e[1].dataType, e[1].dims.length), y = S("scales", e[2].dataType, e[2].dims.length), g = e.length > 3 ? S("zeroPoint", e[3].dataType, e[3].dims.length) : void 0, _ = C("output", d, a.length), w = [
						h,
						b,
						y
					];
        ...
        ${_.setByOffset("global_idx", "dequantized_data")};
				...
				let n = e.inputs;
				rc(n, t), e.compute(oc(e.inputs, t));
			}, da = (e) => V({
				blockSize: e.blockSize,
      ...
      ${f.setByOffset("global_idx", "value")};
			...
			}, ca = (e) => V({ axis: e.axis }), pa = (e, t) => {
				let n = e.inputs;
				ic(n), e.compute(sc(e.inputs, t));
			};
		});
		var ac, uc, fa, ha, ga = k(() => {
			...
			ac = (e) => {
				...
				let n = e[0].dims.slice(), r = e[1].dims.slice(), [o, i, s] = qt.getShapeOfGemmResult(n, t.transA, r, t.transB, e.length === 3 ? e[2].dims : void 0), a = [o, i];
  ...
  ${y.mainStart([
    ...
    if (m < uniforms.M && n < uniforms.N) {
      output[m * uniforms.N + n] = value;
				...
				ac(e.inputs), e.compute(uc(e.inputs, t));
			};
		});
  ...
  ${c.mainStart()}
    ${c.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${hc(s, a, t)}
				...
				dc(e.inputs), e.compute(gc(e.inputs, t));
			}, ba = (e) => V({
		...
		var _e, _c, $a, wa, wc, xt, va, lr = k(() => {
			...
			q();
			Le();
			_e = (e, t) => e.length > t && e[t].dims.length > 0 ? e[t] : void 0, _c = (e, t) => {
				...
				if (s && x.size(s.dims) > 0) {
					_ = 8;
					let T = s.dims;
					throw T.length === 1 ? T[0] === l ? _ = 1 : T[0] === 3 * l + 2 && (_ = 3) : T.length === 2 && T[0] === l && T[1] === g && (_ = 5), _ === 8 ? /* @__PURE__ */ new Error("Input \"key_padding_mask\" shape shall be (batch_size) or (batch_size, total_sequence_length)") : /* @__PURE__ */ new Error("Mask not supported");
				}
				let w = !1, v = p;
  ...
  ${c.mainStart()}
    ...
    qkv_with_bias[global_idx] = qkv[global_idx] + bias[bias_offset_idx];
				...
				if (s && x.size(s.dims) > 0) {
					...
					return u = wc(e, i, s, t, r, n * o, a), u = u.reshape([
						t,
						r,
						n,
						o
					]), n === 1 || r === 1 ? u : e.compute(me(u, wa.perm), {
						inputs: [u],
						outputs: [-1]
					})[0];
				...
				let n = _c(e.inputs, t), r = e.inputs[0], o = _e(e.inputs, 1), i = _e(e.inputs, 2), s = _e(e.inputs, 3), a = _e(e.inputs, 4), u = _e(e.inputs, 5), d = _e(e.inputs, 6), l = _e(e.inputs, 7);
				...
				let c = o && i && o.dims.length === 4 && i.dims.length === 4, p = xt(e, n.batchSize, n.numHeads, n.sequenceLength, n.headSize, r, s, 0);
				if (c) return ut(e, p, o, i, a, void 0, d, l, u, n);
				if (!o || !i) throw new Error("key and value must be provided");
				let f = xt(e, n.batchSize, n.numHeads, n.kvSequenceLength, n.headSize, o, s, n.hiddenSize), m = xt(e, n.batchSize, n.numHeads, n.kvSequenceLength, n.vHeadSize, i, s, 2 * n.hiddenSize);
		...
		var $c, vc, xc, Sc, cr, xa, Sa, pr = k(() => {
			...
			$c = (e) => {
				...
				return e[1].dims[0] > 0 && (e[1].getBigInt64Array().forEach((o) => n.push(Number(o))), r = n.length), V({
					numOutputs: r,
					axis: t.axis,
					splitSizes: n
				});
...
`)}
  ...
  ${m.mainStart()}
    ...
    writeBufferData(output_number, indices, global_idx);
				...
				$c(e.inputs);
				let n = e.inputs.length === 1 ? t : vc(e.inputs, t);
				e.compute(cr(e.inputs, n), { inputs: [0] });
			}, Sa = (e) => {
            ...
            ${v.setByOffset("k", y.getByOffset("k"))}
				...
				return {
					...
					getRunData: () => ({
						...
						dispatchGroup: { x: Math.ceil(x.size(p) / et) },
						programUniforms: m
					})
				};
			}, Ta = (e, t) => {
				Tc(e.inputs, t), e.compute(hn(e.inputs, t));
			};
		});
		var Ic, Cc, Ia, Ac, Ca, Aa = k(() => {
			...
			Ic = (e, t) => {
				...
				let _ = 0, w = !1, v = t.kvNumHeads ? m * t.kvNumHeads : l;
  ...
  `;
				...
				if (e.inputs.length > 14 && e.inputs[14] || e.inputs.length > 15 && e.inputs[15]) throw new Error("GroupQueryAttention (JSEP): q_norm_weight / k_norm_weight inputs are not supported. The per-head Q/K RMS normalization prologue is implemented only on the CUDA and native WebGPU EPs.");
				let n = Ic(e.inputs, t);
				...
				if (t.doRotary) {
					let w = e.compute(Ac(n.batchSize, n.sequenceLength, u, d), {
						inputs: [u, d],
						outputs: [-1]
					})[0], v = e.inputs[7], $ = e.inputs[8], T = V({
				...
				let y = xt(e, n.batchSize, n.numHeads, n.sequenceLength, n.headSize, t.doRotary ? h : p, void 0, 0), g = Ia(e, t.doRotary ? b : f, n), _ = Ia(e, m, n);
				ut(e, y, g, _, void 0, void 0, s, a, void 0, n, u, d);
			};
		});
  ...
  ${g.mainStart(p)}
    ...
    if (local_idx == 0) {
      ...
      output[workgroup_index] = vec2f(channel_scale, channel_shift);
				...
				let r = t[0].dims, o = r, i = 2, s = r[0], a = r[1], u = x.sizeFromDimension(r, i), d = J(u), l = x.size(o) / d, c = Ea(e, t[0], t[1], t[2], s, u, a, n.epsilon), p = [
					s,
					a,
					u / d
				], f = [s, a], m = ["type", "none"], h = (b) => {
					let y = S("x", t[0].dataType, p.length, d), g = S("scale_shift", 1, f.length, 2), _ = C("output", t[0].dataType, p.length, d), w = [
						y,
						g,
						_
					];
  ...
  ${b.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${_.setByOffset("global_idx", "value")};
				...
				let m = p ? e.compute(me(e.inputs[0], f), {
					inputs: [e.inputs[0]],
					outputs: [-1]
				})[0] : e.inputs[0].reshape(Array.from({ length: r.length }, (y, g) => r[f[g]])), h = Ea(e, m, t[1], t[2], i, a, s, n.epsilon), b = (y) => {
  ...
  ${y.mainStart()}
    ...
    output[global_idx] = fma(input[global_idx], ${w(0)}, ${w(1)});
				...
				t.format === "NHWC" ? kc(e, e.inputs, t) : Ec(e, e.inputs, t);
			};
		});
		var Pc, zc, za, Da = k(() => {
			"use strict";
  ...
  ${v.mainStart()}
    ...
    ${g ? "inv_std_output[global_idx] = inv_std_dev" : ""};
				...
				Pc(e.inputs), e.compute(zc(e.inputs, t, e.outputCount));
			};
		});
		var Dc, Ba, Oa = k(() => {
			"use strict";
			...
			Dc = (e) => {
				...
				if (n < 8 && r < 8) e.compute(dn(e.inputs, { activation: "" }, t));
				else {
					...
					if (i !== 1 && o === 1 && s === 1) {
						...
						e.compute(vt(l, { activation: "" }, t, d), { inputs: l });
					} else e.compute(vt(e.inputs, { activation: "" }, t));
				}
			};
		});
		var Bc, Oc, Mc, Ma, Ua, Ra = k(() => {
			"use strict";
			L();
			H();
			ue();
			...
			Bc = (e, t) => {
				...
				let n = e[0].dims, r = n.length, o = n[r - 2], i = t.k, s = t.n, a = n.slice(0, r - 2), u = x.size(a), l = e[1].dims[2] / 4, c = e[0].dataType, p = J(t.k), f = J(l), m = J(s), h = a.concat([o, s]), b = o > 1 && s / m % 2 === 0 ? 2 : 1, y = x.size(h) / m / b, g = 64, _ = [], w = [
					u,
					o,
					i / p
				...
				let T = (I) => {
					...
					K && W.push(K);
					let U = $.length, R = C("output", e[0].dataType, U, m), G = re(e[0].dataType), N = (() => {
						switch (p) {
						...
						let A = "";
						for (let D = 0; D < Q; D++) {
							let oe = D * t.bits * 4, he = oe + t.bits;
							A += `
          // reuse a data (pass ${D})
        ...
        ${I.mainStart([
          ...
          if (local_id.x < ${b}) {
            ...
            ${R.setByIndices(`${R.type.indices}(batch, row, col + local_id.x)`, "output_value")};
				...
				let n = e[0].dims, r = n.length, o = n[r - 2], i = t.k, s = t.n, a = n.slice(0, r - 2), u = x.size(a), l = e[1].dims[2] / 4, c = e[0].dataType, p = J(t.k), f = J(l), m = a.concat([o, s]), h = 128, b = s % 8 === 0 ? 8 : s % 4 === 0 ? 4 : 1, y = h / b, g = Math.floor(32 / t.bits), _ = y * f * g, w = _ / p, v = _ / t.blockSize, $ = x.size(m) / b, T = [], I = [
					u,
					o,
					i / p
				...
				let M = (O) => {
					let W = I.length, K = S("a", e[0].dataType, W, p), U = S("b", 12, E.length, f), R = S("scales", e[2].dataType, e[2].dims.length), G = [
						...
						U,
						R
					], N = e.length === 4 ? S("zero_points", 12, e[3].dims.length) : void 0;
					N && G.push(N);
          ...
          if (local_idx < ${b}) {
            ...
            if (col + local_idx < uniforms.output_shape[2])
            {
              ${Q.setByIndices(`${Q.type.indices}(batch, row, col + local_idx)`, "output_value")}
				...
				Bc(e.inputs, t), t.blockSize === 32 && e.adapterInfo.isVendor("intel") && e.adapterInfo.isArchitecture("gen-12lp") ? e.compute(Mc(e.inputs, t)) : e.compute(Oc(e.inputs, t));
			}, Ua = (e) => V(e);
		});
      ...
      `;
          ...
          `;
				...
				switch (n.mode) {
					case 0: return Rc(e, t, n.pads.length);
					case 1: return Vc(e, t, n.pads.length);
					case 2: return Lc(e, t, n.pads.length);
					case 3: return Nc(e, t, n.pads.length);
				...
				let a = ["rank"], u = (d) => {
					let l = C("output", e[0].dataType, n.length), c = S("x", e[0].dataType, r.length), p = c.type.value, f = Wc(l, r.length, t), m = [{
						name: "output_size",
						type: "u32"
					}, {
						name: "pads",
            ...
            output[global_idx] = value;
				...
				Uc(e.inputs);
				let n = Hc(e.inputs, t);
				e.compute(Gc(e.inputs, n), { inputs: [0] });
			};
		});
		var gn, Na, Wa, Ga, Ha, Fc, qc, Fa, qa, Ka, ja, Za, Qa, Xa, Ya, Ja, eu, tu, nu, ru = k(() => {
			...
			gn = (e) => {
				...
				Je.adjustPoolAttributes(n, o, s, a, u, d);
				let l = Je.computePoolOutputShape(n, o, a, u, s, d, t.autoPad, t.ceilMode), c = Object.assign({}, t);
				i ? Object.assign(c, {
					kernelShape: s,
					strides: a,
					pads: d,
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
			...
			}, Ha = (e) => `${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`, Fc = (e) => `${Ha(e)};${e.countIncludePad}`, qc = (e) => `${Ha(e)};${e.storageOrder};${e.dilations}`, Fa = (e) => ({
				format: e.format,
				autoPad: [
					"NOTSET",
					"VALID",
				...
				let [o, i] = Na(t, r, n), s = S("x", t.dataType, t.dims.length), a = s.type.value, u = "value += x_val;", d = "";
				o.countIncludePad ? d += `value /= ${a}(uniforms.kernelSize);` : d += `value /= ${a}(i32(uniforms.kernelSize) - pad);`;
				let [l, c, p, f, m] = Wa(i, o);
				l.push(...P(t.dims, i));
				return {
					name: e,
					shaderCache: {
					...
					getShaderSource: (b) => Ga(b, s, t.dims.length, i.length, o, u, d, 0, c, p, f, m)
				};
			}, Ka = (e) => {
				let t = e.count_include_pad !== 0, n = Fa(e);
				if (n.ceilMode !== 0) throw new Error("ceil_mode output-shape is computed, but ceil_mode kernel execution (padding/divisor) is not yet implemented in the WebGPU AveragePool kernel");
				let r = {
					countIncludePad: t,
					...n,
					cacheKey: ""
				...
				gn(e.inputs), e.compute(qa("AveragePool", e.inputs[0], !1, t));
			}, Za = {
				autoPad: "",
				ceilMode: 0,
				countIncludePad: !1,
				...
				gn(e.inputs), e.compute(qa("GlobalAveragePool", e.inputs[0], !0, t));
			}, Ya = (e, t, n, r) => {
				let [o, i] = Na(t, r, n), s = `
      value = max(x_val, value);
    `, a = "", u = S("x", t.dataType, t.dims.length), d = ["rank"], [l, c, p, f, m] = Wa(i, o);
				return l.push(...P(t.dims, i)), {
					...
					getShaderSource: (h) => Ga(h, u, t.dims.length, i.length, o, s, a, t.dataType === 10 ? -65504 : -1e5, c, p, f, m)
				};
			}, Ja = (e, t) => {
				gn(e.inputs), e.compute(Ya("MaxPool", e.inputs[0], !1, t));
			}, eu = (e) => {
				let t = e.storage_order, n = e.dilations, r = Fa(e);
				if (t !== 0) throw new Error("column major storage order is not yet supported for MaxPool");
				if (r.ceilMode !== 0) throw new Error("ceil_mode output-shape is computed, but ceil_mode kernel execution (padding) is not yet implemented in the WebGPU MaxPool kernel");
				let o = {
					storageOrder: t,
					dilations: n,
					...r,
				...
				gn(e.inputs), e.compute(Ya("GlobalMaxPool", e.inputs[0], !0, t));
			};
		});
		var jc, Zc, ou, iu, su = k(() => {
			...
			jc = (e, t) => {
				...
				let n = x.normalizeAxis(t.axis, e[0].dims.length), r = e[0].dataType, o = r === 3, i = e[0].dims, s = e[1].dataType, a = x.size(i), u = r === 3 || r === 2, d = u ? [Math.ceil(x.size(e[0].dims) / 4)] : e[0].dims, l = e[1].dims, c = e.length > 2 ? e[2] : void 0, p = c ? u ? [Math.ceil(x.size(c.dims) / 4)] : c.dims : void 0, f = l.length === 0 || l.length === 1 && l[0] === 1, m = f === !1 && l.length === 1, h = J(a), b = f && (!u || h === 4), y = b ? h : 1, g = b && !u ? h : 1, _ = S("input", u ? 12 : r, d.length, g), w = S("scale", s, l.length), v = c ? S("zero_point", u ? 12 : r, p.length) : void 0, $ = C("output", s, i.length, y), T = [_, w];
				v && T.push(v);
				let I = [d, l];
				c && I.push(p);
				let E = [
      ...
      ${$.setByOffset("global_idx", `${$.type.value}(x_value - zero_point_value) * scale_value`)};
				...
				jc(e.inputs, t), e.compute(Zc(e.inputs, t));
			}, iu = (e) => V({
				axis: e.axis,
				blockSize: e.blockSize
			});
			...
			Yc = (e, t, n, r) => {
              ...
              ${o}bitcast<${r}>(oldValue) + (${n})${i}`;
				...
				let n = e[0].dims, r = e[1].dims, o = n, i = 1, s = Math.ceil(x.sizeToDimension(r, r.length - 1) / i), a = r[r.length - 1], u = x.sizeFromDimension(n, a), d = [
					...
					let p = S("indices", e[1].dataType, e[1].dims.length), f = S("updates", e[2].dataType, e[2].dims.length, i), m = t.reduction !== "none" && t.reduction !== "" ? Ao("output", e[0].dataType, o.length) : C("output", e[0].dataType, o.length, i);
					return `
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${Yc(t.reduction, "output[data_offset + i]", "value", m.type.value)}
			...
			}, du = (e) => V({ reduction: e.reduction }), lu = (e, t) => {
				e.compute(Jc(e.inputs, t), {
		...
		var ep, tp, np, pu, rp, op, ip, sp, ap, up, dp, lp, mu, cp, pp, mp, fp, hp, fu, hu, gu = k(() => {
            ...
            one outermost scale values equal to 1, or 5D with two outermost scale values equal to 1`);
				...
				if (a > 0 && e.length > a && e[a].dims.length === 1 && e[a].dims[0] > 0) {
					...
					ep(r, t), t.axes.length > 0 && tp(r, t.axes, d).forEach((l, c) => r[c] = l);
				}
...
`, rp = (e, t) => `fn getOriginalCoordinateFromResizedCoordinate(xResized: u32, xScale: f32, lengthResized: u32,
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${t} { ` + (() => {
        ...
        `;
			...
			})() + "}", op = (e, t, n) => `fn getNearestPixelFromOriginal(xOriginal: ${n}, isDownSample: bool) -> ${n} {` + (() => {
				switch (e) {
...
` : "", cp = (e, t, n, r, o) => {
    ...
    fn bilinearInterpolation(output_indices: ${t.type.indices}) -> ${l} {
      ...
      return (x11 * dx2 * dy2 + x12 * dx2 * dy1 + x21 * dx1 * dy2 + x22 * dx1 * dy1);
				...
				let [p, f] = n.length === 2 ? [0, 1] : [2, 3], m = e.type.value, h = (b) => {
					let y = b === p ? "row" : "col";
					return `
    ...
    depth = max(0, min(depth, ${n[a]} - 1));
      ...
      return (x111 * dx2 * dy2 * dz2 + x112 * dx2 * dy2 * dz1 + x121 * dx2 * dy1 *dz2 + x122 * dx2 * dy1 * dz1 +
              x211 * dx1 * dy2 * dz2 + x212 * dx1 * dy2 * dz1 + x221 * dx1 * dy1 *dz2 + x222 * dx1 * dy1 * dz1);
				...
				let s = e.dims, a = ip(i, t.axes, s.length), u = sp(s, r, o, t.axes), d = r.slice();
				r.length === 0 && (d = s.map((g, _) => g === 0 ? 1 : u[_] / g), t.keepAspectRatioPolicy !== "stretch" && (u = ap(s, d, t)));
      ...
      ${(() => {
              ...
              ${(() => {
							if (s.length === 2 || s.length === 4) return `${cp(c, l, s, m, h)}`;
							if (s.length === 3 || s.length === 5) return `${mp(c, l, s, m, h)}`;
							throw Error("Linear mode only supports input dims 2, 3, 4 and 5 are supported in linear mode.");
						})()};
            `;
						case "cubic": return `
            ${(() => {
							if (s.length === 2 || s.length === 4) return `${pp(c, l, s, u, d, a, t.cubicCoeffA, m, t.extrapolationValue, t.excludeOutside)}`;
...
`}
				...
				np(e.inputs, t, i, n, r, o), e.compute(fp(e.inputs[0], t, i, n, r, o), { inputs: [0] });
			}, hu = (e) => {
		...
		var gp, yp, yu, bu = k(() => {
			...
			gp = (e) => {
				...
				let o = t.simplified, i = e[0].dims, s = x.size(i), a = i, u = s, d = i.slice(-1)[0], l = r ? i.slice(0, -1).concat(1) : [], c = !o && e.length > 3, p = e.length > 4, f = r && n > 1, m = r && n > 2, h = n > 3, b = 64, y = J(d), g = [
					{
						type: 12,
						data: u
					},
      ...
      ${v.mainStart([
        ...
        for (var i: u32 = 0; i < stride; i++) {
          output[offset + i] = (output[offset + i] ${o ? "" : `- ${I}(mean)`}) *
            ...
            ${c ? "+ beta[offset1d + i]" : ""};
				...
				gp(e.inputs);
				let r = [0];
				e.outputCount > 1 && r.push(-3), e.outputCount > 2 && r.push(-3), e.outputCount > 3 && r.push(3), e.compute(yp(e.inputs, t, e.outputCount, !1), { outputs: r });
			};
		});
		var bp, yn, _p, _u, wp, $p, wu, $u, vu = k(() => {
			...
			bp = (e, t) => {
				...
				if (e.length > 1) {
					let n = yn(e, 1), r = yn(e, 2), o = yn(e, 3);
					return o.length === 0 && (o = [...Array(e[0].dims.length).keys()]), V({
						starts: n,
						ends: r,
						axes: o
					});
			...
			}, wp = (e, t, n) => `fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
          ...
          return input_indices;
				...
				let n = e[0].dims, r = x.size(n), o = t.axes.length > 0 ? x.normalizeAxes(t.axes, n.length) : [...Array(n.length).keys()], i = yn(e, 4);
				i.forEach((y) => y !== 0 || (() => {
					throw new Error("step cannot be 0");
				})), i.length === 0 && (i = Array(o.length).fill(1));
				let s = t.starts.map((y, g) => _u(y, g, n, o, i)), a = t.ends.map((y, g) => _u(y, g, n, o, i));
      ...
      ${y.registerUniforms(m).declareVariables(p, c)}
        ...
        ${y.mainStart()}
          ...
          ${c.setByOffset("global_idx", p.getByIndices("input_indices"))}
				...
				bp(e.inputs, t);
				let n = _p(e.inputs, t);
				e.compute($p(e.inputs, n), { inputs: [0] });
			}, $u = (e) => {
      ...
      ${T.mainStart(h)}
		...
		var Iu, Sp, Tp, Ip, Cu, Au = k(() => {
			...
			H();
			q();
			Iu = (e) => Array.from(e.getBigInt64Array(), Number), Sp = (e) => {
				...
				if (Iu(e[1]).length !== e[0].dims.length) throw new Error("Tile `repeats` input should have same number of elements as rank of input data tensor");
			}, Tp = (e, t) => {
				let n = [];
      ...
      ${u.setByOffset("global_idx", a.getByIndices("input_indices"))}
				...
				Sp(e.inputs), e.compute(Ip(e.inputs), { inputs: [0] });
			};
		});
		var Cp, Ap, Eu, ku = k(() => {
			"use strict";
        ...
        ${d}
				...
				return {
					...
					getShaderSource: (d) => Cp(d, e, s, i, o),
					getRunData: () => ({
						outputs: [{
							dims: s,
							dataType: o
		...
		var Pu, zu = k(() => {
			...
			Pu = /* @__PURE__ */ new Map([
				...
				["FusedConv", [ir, or]],
				["Gather", [ra, na]],
				["GatherElements", [pa, ca]],
				["GatherBlockQuantized", [ua, da]],
				["GatherND", [ia, sa]],
				["Gelu", [Ii]],
				["Gemm", [ha, fa]],
				["GlobalAveragePool", [Xa, Qa]],
				["GlobalMaxPool", [nu, tu]],
				["Greater", [ts]],
				["GreaterOrEqual", [rs]],
				["GridSample", [ya, ba]],
				["GroupQueryAttention", [Ca]],
				["HardSigmoid", [Bi, Di]],
				["HardSwish", [Oi]],
				["InstanceNormalization", [ka]],
				["LayerNormalization", [za]],
				["LeakyRelu", [Ci, wt]],
				["Less", [ns]],
				["LessOrEqual", [os]],
				["Log", [Hi]],
		...
		var bn, Du = k(() => {
			...
			bn = class {
				...
				build(t, n) {
					...
					let s = Eo(n, this.backend.device.limits), a = t.getShaderSource(s), u = `${o.join(`
`)}
...
${a}`, d = r.createShaderModule({
		...
		var Bu = {};
		it(Bu, { WebGpuBackend: () => hr });
		var Ep, kp, fr, hr, Ou = k(() => {
			"use strict";
			we();
			L();
			Pe();
			...
			Ep = (e, t) => {
				...
				let r = e.name;
				return e.shaderCache?.hint && (r += "[" + e.shaderCache.hint + "]"), r += ":" + n + `:${Ep(t, e.shaderCache?.inputDependencies ?? new Array(t.length).fill("dims"))}`, r;
			}, fr = class {
				constructor(t) {
				...
				async initialize(t, n) {
					...
					let r = [], o = {
						...
						requiredFeatures: r
					}, i = (u) => n.features.has(u) && r.push(u) && !0;
					i("chromium-experimental-timestamp-query-inside-passes") || i("timestamp-query"), i("shader-f16"), i("subgroups"), this.device = await n.requestDevice(o);
					let s = n, a = n.info ?? (typeof s.requestAdapterInfo == "function" ? await s.requestAdapterInfo() : void 0);
					this.adapterInfo = new fr(a), this.gpuDataManager = Io(this), this.programManager = new bn(this), this.kernels = /* @__PURE__ */ new Map(), this.kernelPersistentData = /* @__PURE__ */ new Map(), this.kernelCustomData = /* @__PURE__ */ new Map(), Ft(t.logLevel, !!t.debug), this.device.onuncapturederror = (u) => {
						u.error instanceof GPUValidationError && console.error(`An uncaught WebGPU validation error was raised: ${u.error.message}`);
				...
				run(t, n, r, o, i, s) {
					...
					if (l) {
						...
						l.forEach((I) => {
							...
							I.type === 10 ? (O = E.length > 4 ? 16 : E.length > 2 ? 8 : E.length * z, M = E.length > 4 ? 16 : z * E.length) : (O = E.length <= 2 ? E.length * z : 16, M = 16), _ = Math.ceil(_ / O) * O, w.push(_);
							let W = I.type === 10 ? 8 : 4;
							_ += E.length > 4 ? Math.ceil(E.length / W) * M : E.length * z;
						});
						let v = 16;
						_ = Math.ceil(_ / v) * v;
						...
						this.device.queue.writeBuffer(T.buffer, 0, $, 0, _), this.gpuDataManager.release(T.id), m = {
							offset: 0,
							size: _,
							buffer: T.buffer
						};
					}
					let h = this.programManager.normalizeDispatchGroupSize(d), b = h[1] === 1 && h[2] === 1, y = kp(t, n, b), g = this.programManager.getArtifact(y);
				...
				createDownloader(t, n, r) {
					return async () => {
						let o = await Hn(this, t, n);
						return Kt(o.buffer, r);
					};
				}
				writeTimestamp(t) {
		...
		var St, gr, Pp, Uu = k(() => {
			...
			St = class e {
				...
				compute(t, n) {
					let r = n?.inputs?.map((a) => typeof a == "number" ? this.inputs[a] : a) ?? this.inputs, o = n?.outputs ?? [], i = (a, u, d) => new St(this.module, u, this.output(a, d), d), s = (a, u) => {
						let d = qe(a, u);
						if (!d) throw new Error(`Unsupported data type: ${a}`);
						let l = d > 0 ? this.backend.gpuDataManager.create(d).id : 0;
						return new St(this.module, a, l, u);
					};
				...
				if (e === "webgpu") {
					let i = (Ou(), mt(Bu)).WebGpuBackend, s = new i();
		...
		var zp, Dt, Bt, rt, Dp, Ru, gt, Ot, Mt, Vu, Ut, Rt, Vt, zn = k(() => {
			"use strict";
			we();
			uo();
			co();
			...
			zp = (e, t) => {
				...
				zp(e.wasm.numThreads, bt(e.logLevel));
			}, Bt = async (e, t) => {
				ne().asyncInit?.();
				...
				let n, r, o = ne();
				Array.isArray(e) ? [n, r] = e : e.buffer === o.HEAPU8.buffer ? [n, r] = [e.byteOffset, e.byteLength] : [n, r] = gt(e);
				let i = 0, s = 0, a = 0, u = [], d = [], l = [];
				try {
					if ([s, u] = await lo(t), t?.externalData && o.mountExternalData) {
						let w = [];
						for (let v of t.externalData) {
							let $ = typeof v == "string" ? v : v.path, T = typeof v == "string" ? v : v.data;
							w.push(_t(T).then((I) => {
								o.mountExternalData($, I);
							}));
						}
						await Promise.all(w);
					}
					...
					let [c, p] = Dp(i), f = !!t?.enableGraphCapture, m = [], h = [], b = [], y = [], g = [];
					for (let w = 0; w < c; w++) {
						let [v, $, T] = Ru(i, w);
					...
					let _ = null;
					return g.some((w) => w === "gpu-buffer" || w === "ml-tensor" || w === "ml-tensor-cpu-output") && (a = o._OrtCreateBinding(i), a === 0 && Y("Can't create IO binding."), _ = {
						handle: a,
						outputPreferredLocations: g,
						outputPreferredLocationsEncoded: g.map((w) => w === "ml-tensor-cpu-output" ? "ml-tensor" : w).map((w) => Mn(w))
					}), rt.set(i, [
						i,
						d,
						l,
				...
				try {
					...
					let y = a._OrtCreateTensor(Fe(d), f, m, b, l.length, Mn(p));
					y === 0 && Y(`Can't create tensor for input/output. session=${r}, index=${i}.`), t.push(y);
				} finally {
					a.stackRestore(h);
				}
			}, Ut = async (e, t, n, r, o, i) => {
				let s = ne(), a = s.PTR_SIZE, u = rt.get(e);
				if (!u) throw new Error(`cannot run inference. invalid session id: ${e}`);
				let d = u[0], l = u[1], c = u[2], p = u[3], f = u[4], m = u[5], h = t.length, b = r.length, y = 0, g = [], _ = [], w = [], v = [], $ = [], T = s.stackSave(), I = s.stackAlloc(h * a), E = s.stackAlloc(h * a), z = s.stackAlloc(b * a), M = s.stackAlloc(b * a);
				try {
					[y, g] = ao(i), Re("wasm prepareInputOutputTensor");
					for (let U = 0; U < h; U++) await Vu(n[U], _, v, e, l[t[U]], t[U], f);
					for (let U = 0; U < b; U++) await Vu(o[U], w, v, e, c[r[U]], h + r[U], f);
					Ve("wasm prepareInputOutputTensor");
					for (let U = 0; U < h; U++) s.setValue(I + U * a, _[U], "*"), s.setValue(E + U * a, l[t[U]], "*");
					for (let U = 0; U < b; U++) s.setValue(z + U * a, w[U], "*"), s.setValue(M + U * a, c[r[U]], "*");
					if (p && !m) {
						...
						for (let N = 0; N < h; N++) {
							let j = t[N];
							await s._OrtBindInput(U, l[j], _[N]) !== 0 && Y(`Can't bind input[${N}] for session=${e}.`);
						}
						for (let N = 0; N < b; N++) {
							let j = r[N];
							o[N]?.[3] ? ($.push(w[N]), s._OrtBindOutput(U, c[j], w[N], 0) !== 0 && Y(`Can't bind pre-allocated output[${N}] for session=${e}.`)) : s._OrtBindOutput(U, c[j], 0, G[j]) !== 0 && Y(`Can't bind output[${N}] to ${R[N]} for session=${e}.`);
						}
						Ve("wasm bindInputsOutputs"), rt.set(e, [
							d,
							l,
							c,
							p,
					...
					let O;
					p ? O = await s._OrtRunWithBinding(d, p.handle, b, z, y) : O = await s._OrtRun(d, E, I, h, M, b, z, y), O !== 0 && Y("failed to call OrtRun().");
					let W = [], K = [];
					...
					for (let U = 0; U < b; U++) {
						...
						let G = s.stackSave(), N = s.stackAlloc(4 * a), j = !1, Q, X = 0;
						try {
							s._OrtGetTensorData(R, N, N + a, N + 2 * a, N + 3 * a) !== 0 && Y(`Can't access output tensor data on index ${U}.`);
							let se = a === 4 ? "i32" : "i64", A = Number(s.getValue(N, se));
							X = s.getValue(N + a, "*");
							let D = s.getValue(N + a * 2, "*"), oe = Number(s.getValue(N + a * 3, se)), he = [];
							for (let ie = 0; ie < oe; ie++) he.push(Number(s.getValue(D + ie * a, se)));
							s._OrtFree(D) !== 0 && Y("Can't free memory for tensor dims.");
							let ae = he.reduce((ie, le) => ie * le, 1);
							Q = ke(A);
							...
							if (Q === "string") {
								...
								for (let le = 0; le < ae; le++) {
									let We = s.getValue(X + le * a, "*"), It = s.getValue(X + (le + 1) * a, "*"), wr = le === ae - 1 ? void 0 : It - We;
									ie.push(s.UTF8ToString(We, wr));
								}
								W.push([
									Q,
									he,
								...
								let le = ie(X), We = qe(A, ae);
								if (We === void 0 || !Gt(Q)) throw new Error(`Unsupported data type: ${Q}`);
								j = !0, W.push([
									Q,
									he,
									{
										gpuBuffer: le,
										download: s.jsepCreateDownloader(le, We, Q),
										dispose: () => {
								...
								let ie = s.webnnEnsureTensor, le = s.webnnIsGraphInputOutputTypeSupported;
								if (!ie || !le) throw new Error("preferredLocation \"ml-tensor\" is not supported without using WebNN.");
								if (qe(A, ae) === void 0 || !Ht(Q)) throw new Error(`Unsupported data type: ${Q}`);
								if (!le(e, Q, !1)) throw new Error(`preferredLocation "ml-tensor" for ${Q} output is not supported by current WebNN Context.`);
								let It = await ie(e, X, A, he, !1);
								j = !0, W.push([
									Q,
									he,
									{
								...
								let ie = s.webnnCreateMLTensorDownloader(X, Q)(), le = W.length;
								j = !0, K.push((async () => {
									let We = [le, await ie];
								...
								let le = new (at(Q))(ae);
								new Uint8Array(le.buffer, le.byteOffset, le.byteLength).set(s.HEAPU8.subarray(X, X + le.byteLength)), W.push([
									Q,
									he,
									le,
									"cpu"
					...
					p && !f && (s._OrtClearBoundOutputs(p.handle) !== 0 && Y("Can't clear bound outputs."), rt.set(e, [
						d,
						l,
						c,
						p,
					...
					s.webnnOnRunEnd?.(d), s.stackRestore(T), _.forEach((O) => s._OrtReleaseTensor(O)), w.forEach((O) => s._OrtReleaseTensor(O)), v.forEach((O) => s._free(O)), y !== 0 && s._OrtReleaseRunOptions(y), g.forEach((O) => s._free(O));
				}
			}, Rt = (e) => {
				let t = ne(), n = rt.get(e);
		...
		var ot, Se, Tt, wn, $n, _n, yr, br, ct, pt, Op, Lu, Nu, Wu, Gu, Hu, Fu, qu, _r = k(() => {
			"use strict";
			we();
			zn();
			He();
			Pt();
			ot = () => !!te.wasm.proxy && typeof document < "u", Tt = !1, wn = !1, $n = !1, br = /* @__PURE__ */ new Map(), ct = (e, t) => {
				let n = br.get(e);
				n ? n.push(t) : br.set(e, [t]);
			}, pt = () => {
				if (Tt || !wn || $n || !Se) throw new Error("worker not ready");
			}, Op = (e) => {
				switch (e.data.type) {
					case "init-wasm":
						Tt = !1, e.data.err ? ($n = !0, yr[1](e.data.err)) : (wn = !0, yr[0]()), _n && (URL.revokeObjectURL(_n), _n = void 0);
						break;
					case "init-ep":
					case "copy-from":
					case "create":
				...
				if (!wn) {
					if (Tt) throw new Error("multiple calls to 'initWasm()' detected.");
					if ($n) throw new Error("previous call to 'initWasm()' failed.");
					if (Tt = !0, ot()) return new Promise((e, t) => {
						Se?.terminate(), oo().then(([n, r]) => {
							try {
								Se = r, Se.onerror = (i) => t(i), Se.onmessage = Op, yr = [e, t];
								let o = {
									type: "init-wasm",
									in: te
								};
					...
					try {
						await zt(te.wasm), await Dt(te), wn = !0;
					} catch (e) {
						throw $n = !0, e;
					} finally {
						Tt = !1;
				...
				if (ot()) return pt(), new Promise((t, n) => {
					ct("init-ep", [t, n]);
					let r = {
						type: "init-ep",
						in: {
				...
				await Bt(te, e);
			}, Wu = async (e) => ot() ? (pt(), new Promise((t, n) => {
				ct("copy-from", [t, n]);
				let r = {
					type: "copy-from",
					in: { buffer: e }
				...
				if (ot()) {
					...
					return pt(), new Promise((s, a) => {
						...
						Se.postMessage(d, Vt(u));
					});
				} else return Ut(e, t, n, r, o, i);
			}, qu = async (e) => {
				if (ot()) return pt(), new Promise((t, n) => {
					ct("end-profiling", [t, n]);
					let r = {
						type: "end-profiling",
						in: e
					};
		...
		var Ku, Mp, vn, ju = k(() => {
			...
			Ku = (e, t) => {
				...
				switch (e[3]) {
					...
					case "gpu-buffer": {
						let t = e[0];
						if (!Gt(t)) throw new Error(`not supported data type: ${t} for deserializing GPU tensor`);
					...
					case "ml-tensor": {
						let t = e[0];
						if (!Ht(t)) throw new Error(`not supported data type: ${t} for deserializing MLTensor tensor`);
				...
				async fetchModelAndCopyToWasmMemory(t) {
					return Wu(await _t(t));
				}
				async loadModel(t, n) {
					be();
					let r;
					typeof t == "string" ? r = await this.fetchModelAndCopyToWasmMemory(t) : r = t, [this.sessionId, this.inputNames, this.outputNames, this.inputMetadata, this.outputMetadata] = await Gu(r, n), ye();
				}
				async dispose() {
					return Hu(this.sessionId);
				}
				async run(t, n, r) {
					be();
					let o = [], i = [];
					...
					let u = o.map((p, f) => Ku(p, () => `input "${this.inputNames[i[f]]}"`)), d = s.map((p, f) => p ? Ku(p, () => `output "${this.outputNames[a[f]]}"`) : null), l = await Fu(this.sessionId, i, u, a, d, r), c = {};
					for (let p = 0; p < l.length; p++) c[this.outputNames[a[p]]] = s[p] ?? Mp(l[p]);
					return ye(), c;
				}
				startProfiling() {}
				endProfiling() {
		...
		var Qu = {};
		it(Qu, {
			OnnxruntimeWebAssemblyBackend: () => xn,
			initializeFlags: () => Zu,
			wasmBackend: () => Up
		});
		var Zu, xn, Up, Xu = k(() => {
			...
			Zu = () => {
				...
				if (typeof e != "boolean" && e !== void 0 && e !== "fixed" && e !== "relaxed" && (console.warn(`Property "env.wasm.simd" is set to unknown value "${e}". Reset it to \`false\` and ignore SIMD feature checking.`), te.wasm.simd = !1), typeof te.wasm.proxy != "boolean" && (te.wasm.proxy = !1), typeof te.wasm.trace != "boolean" && (te.wasm.trace = !1), typeof te.wasm.numThreads != "number" || !Number.isInteger(te.wasm.numThreads) || te.wasm.numThreads <= 0) if (typeof self < "u" && !self.crossOriginIsolated) te.wasm.numThreads = 1;
					...
					let t = typeof navigator > "u" ? Tn("node:os").cpus().length : navigator.hardwareConcurrency;
					te.wasm.numThreads = Math.min(4, Math.ceil((t || 1) / 2));
				}
			}, xn = class {
				async init(t) {
					Zu(), await Lu(), await Nu(t);
				}
...
//#endregion
//#region node_modules/@ricky0123/vad-web/dist/models/silero.js
var require_silero = /* @__PURE__ */ __commonJSMin(((exports) => {
	var _a;
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.Silero = void 0;
	var logging_1 = require_logging();
	var CONTEXT_SAMPLES = 64;
	...
	var Silero = class {
		constructor(_session, _state, _sr, ortInstance) {
			...
			this.process = async (audioFrame) => {
				...
				this._context = audioFrame.slice(-64);
				const inputs = {
					input: new this.ortInstance.Tensor("float32", withContext, [1, withContext.length]),
					state: this._state,
					sr: this._sr
				};
				const out = await this._session.run(inputs);
	...
	_a = Silero;
	Silero.new = async (ortInstance, modelFetcher) => {
...
var require_models = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.Silero = exports.SileroLegacy = void 0;
	...
	var silero_1 = require_silero();
	Object.defineProperty(exports, "Silero", {
		enumerable: true,
		get: function() {
			return silero_1.Silero;
		}
	});
}));
//#endregion
	...
	var ort = (() => {
		...
		var Se = (e, t) => {
			...
			if (t && typeof t == "object" || typeof t == "function") for (let r of Ln(t)) !Pn.call(e, r) && r !== n && Je(e, r, {
				get: () => t[r],
				enumerable: !(o = On(t, r)) || o.enumerable
			});
			return e;
		};
		var Ye = (e) => Dn(Je({}, "__esModule", { value: !0 }), e);
		var Te, K, se, _n, bt, Ze = E(() => {
			"use strict";
				...
				if (n) {
					...
					if (i) return new Promise((l, c) => {
						...
						h.crossOrigin = "Anonymous", h.src = e, h.onload = () => {
							...
							a.height = d.height, a.width = d.width, l(Ke(b.data, a));
						};
					});
					throw new Error("Input data provided is not supported - aborted tensor creation");
				}
		...
		var Mt, Rt, Nt = E(() => {
			...
			Mt = (e) => {
				...
				switch (e.location) {
					case "cpu": return new v(e.type, e.data, t);
					case "cpu-pinned": return new v({
						location: "cpu-pinned",
						data: e.data,
						type: e.type,
						dims: t
					});
					case "texture": return new v({
						location: "texture",
						texture: e.texture,
						type: e.type,
						dims: t
					});
					case "gpu-buffer": return new v({
						location: "gpu-buffer",
						gpuBuffer: e.gpuBuffer,
						type: e.type,
						dims: t
					});
					case "ml-tensor": return new v({
						location: "ml-tensor",
						mlTensor: e.mlTensor,
						type: e.type,
						dims: t
			...
			qt && (self.onmessage = (e) => {
				...
				try {
					switch (t) {
						...
						case "end-profiling": ve(n), postMessage({ type: t });
					}
				} catch (o) {
					postMessage({
						type: t,
		...
		var st, it, Re, nn, Nn, Fn, kn, Le, I, ee = E(() => {
			...
			it = !1, Re = !1, nn = !1, Nn = () => {
				...
				if (t > 0 && h.push(new Promise((b) => {
					...
					d(m).then((w) => {
						Re = !1, it = !0, st = w, b(), c && URL.revokeObjectURL(c);
					}, (w) => {
						Re = !1, nn = !0, A(w);
					});
		...
		var Hn, Pe, De, fe, jn, dn, we, _e, Ue, ln, xe, ve, Ce, rt = E(() => {
			"use strict";
			X();
			on();
			an();
			...
			Hn = (e, t) => {
				...
				try {
					...
					for (let g of t?.executionProviders ?? []) if ((typeof g == "string" ? g : g.name) === "webnn") {
						if (r.shouldTransferToMLTensor = !1, typeof g != "string") {
							let x = g, M = x?.context, _ = x?.gpuDevice, le = x?.deviceType, re = x?.powerPreference;
							M ? r.currentContext = M : _ ? r.currentContext = await r.webnnCreateMLContext(_) : r.currentContext = await r.webnnCreateMLContext({
								deviceType: le,
								powerPreference: re
							});
					...
					let [c, d] = jn(i), p = !!t?.enableGraphCapture, h = [], b = [], A = [], m = [];
					for (let g = 0; g < c; g++) {
						let [T, x, M] = dn(i, g);
					...
					throw f.forEach((d) => r._OrtFree(d)), l.forEach((d) => r._OrtFree(d)), i !== 0 && r._OrtReleaseSession(i) !== 0 && S("Can't release session."), c;
				} finally {
				...
				try {
					...
					let m = a._OrtCreateTensor(ae(f), p, h, A, l.length, cn(d));
				...
				u[5];
				let b = t.length, A = o.length, m = 0, w = [], O = [], g = [], T = [], x = [], M = s.stackSave(), _ = s.stackAlloc(b * a), le = s.stackAlloc(b * a), re = s.stackAlloc(A * a), lt = s.stackAlloc(A * a);
				try {
					...
					for (let y = 0; y < b; y++) s.setValue(_ + y * a, O[y], "*"), s.setValue(le + y * a, l[t[y]], "*");
					for (let y = 0; y < A; y++) s.setValue(re + y * a, g[y], "*"), s.setValue(lt + y * a, c[o[y]], "*");
					s.jsepOnRunStart?.(f), s.webnnOnRunStart?.(f);
					let F;
					F = await s._OrtRun(f, le, _, b, lt, A, re, m), F !== 0 && S("failed to call OrtRun().");
					let z = [], pt = [];
					Y("wasm ProcessOutputTensor");
					for (let y = 0; y < A; y++) {
						let G = Number(s.getValue(re + y * a, "*"));
						if (G === g[y] || x.includes(g[y])) {
							z.push(r[y]), G !== g[y] && s._OrtReleaseTensor(G) !== 0 && S("Can't release tensor.");
							continue;
						}
						let mt = s.stackSave(), $ = s.stackAlloc(4 * a), oe = !1, P, C = 0;
						try {
							s._OrtGetTensorData(G, $, $ + a, $ + 2 * a, $ + 3 * a) !== 0 && S(`Can't access output tensor data on index ${y}.`);
							let Ve = a === 4 ? "i32" : "i64", ge = Number(s.getValue($, Ve));
							C = s.getValue($ + a, "*");
							let wt = s.getValue($ + a * 2, "*"), Bn = Number(s.getValue($ + a * 3, Ve)), H = [];
							for (let U = 0; U < Bn; U++) H.push(Number(s.getValue(wt + U * a, Ve)));
							s._OrtFree(wt) !== 0 && S("Can't free memory for tensor dims.");
							let j = H.reduce((U, L) => U * L, 1);
							P = Fe(ge);
							let pe = d?.outputPreferredLocations[o[y]];
							if (P === "string") {
					...
					for (let [y, G] of await Promise.all(pt)) z[y][2] = G;
		...
		var ne, W, ye, $e, ze, Ge, ft, ct, ce, de, Jn, pn, mn, wn, hn, bn, yn, gn, dt = E(() => {
			...
			ee();
			Oe();
			ne = () => !!B.wasm.proxy && typeof document < "u", ye = !1, $e = !1, ze = !1, ct = /* @__PURE__ */ new Map(), ce = (e, t) => {
				let n = ct.get(e);
				...
				if (!$e) {
					...
					try {
						await Le(B.wasm), await Pe(B), $e = !0;
					} catch (e) {
						throw ze = !0, e;
					} finally {
						ye = !1;
		...
		var Tn, je, Yn, An = E(() => {
			...
			Tn = () => {
				...
				let e = B.wasm.simd;
				if (typeof e != "boolean" && e !== void 0 && e !== "fixed" && e !== "relaxed" && (console.warn(`Property "env.wasm.simd" is set to unknown value "${e}". Reset it to \`false\` and ignore SIMD feature checking.`), B.wasm.simd = !1), typeof B.wasm.proxy != "boolean" && (B.wasm.proxy = !1), typeof B.wasm.trace != "boolean" && (B.wasm.trace = !1), typeof B.wasm.numThreads != "number" || !Number.isInteger(B.wasm.numThreads) || B.wasm.numThreads <= 0) if (typeof self < "u" && !self.crossOriginIsolated) B.wasm.numThreads = 1;
				else {
		...
		Object.defineProperty(B.versions, "web", {
			value: Vt,
			enumerable: !0
		});
		return Ye(Xn);
			...
			this.start = async () => {
				switch (this.initializationState) {
					...
					case "errored":
						...
						break;
					default: logging_1.log.warn("weird initialization state");
				}
			};
			this.pause = async () => {
				if (!this.listening) return;
			...
			this.handleFrameProcessorEvent = (ev) => {
				switch (ev.msg) {
					...
					case messages_1.Message.VADMisfire:
						...
						break;
					case messages_1.Message.SpeechEnd: this.options.onSpeechEnd(ev.audio);
				}
			};
		}
		static async new(options = {}) {
			...
			const modelFactory = fullOptions.model === "legacy" ? models_1.SileroLegacy.new : models_1.Silero.new;
			let model;
			try {
