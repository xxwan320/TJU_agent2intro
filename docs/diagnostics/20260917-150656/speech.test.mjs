...
await build({ configFile: false, logLevel: 'silent', build: { outDir: 'docs/diagnostics/20260917-150656/offline-build', emptyOutDir: false, minify: false, lib: { entry: 'tests/speech/r3-entry.ts', formats: ['es'], fileName: () => 'r3.js' } } });
const { CampusSpeechAdapter, CampusSpeechController, createSpeechInteractionController, KelaitaAvatarAdapter } = await import(pathToFileURL(`${process.cwd()}/docs/diagnostics/20260917-150656/offline-build/r3.js`));
