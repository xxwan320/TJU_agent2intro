...
await page.route('**/*',async route=>{
 ...
 if(sample===2){
  ...
  await page.screenshot({path:'docs/diagnostics/ab-closeout/20260925-closeout/cancel.png',fullPage:true});
 }
 await context.close();
}
...
await fs.writeFile('docs/diagnostics/ab-closeout/20260925-closeout/performance-final.json',JSON.stringify(report,null,2));await browser.close();console.log(JSON.stringify(report,null,2));
