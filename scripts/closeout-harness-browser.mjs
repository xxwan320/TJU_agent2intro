...
await check('point selection actual text and image, A-B-A stale guards',async()=>{
 ...
 for(const [index,id] of ['beiyangyuan-zhengdong-library','beiyangyuan-datong-center','beiyangyuan-zhengdong-library'].entries()){
 ...
 return {ids:['beiyangyuan-zhengdong-library','beiyangyuan-datong-center','beiyangyuan-zhengdong-library']};
});
